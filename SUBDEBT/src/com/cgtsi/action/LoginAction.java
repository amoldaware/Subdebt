...
public class LoginAction extends BaseAction
{
    ...
    public ActionForward login(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws DatabaseException, UserLockedException, InactiveUserException, InvalidPasswordException, NoUserFoundException, IOException
    {
    	String targetValue="";
    	String strUserCaptcha=null;
    	String strSystemCaptcha=null;
        ...
        /*Get System Captch from Session*/
        if(session.getAttribute("captcha_key_name")!=null){
        	strSystemCaptcha = (String)session.getAttribute("captcha_key_name");
        }else{
        	//System.out.println("Captch is null");
        }
        /*User Given Captch*/
        if(request.getParameter("inputText")!=null){
        	strUserCaptcha = request.getParameter("inputText");
        }else{
        	//System.out.println("User given captch is null");
        }
        //System.out.println("System :"+strSystemCaptcha+" User:"+strUserCaptcha);
  	  // Change 2 Added By Parmanand Start 22-05-2020 start
        if(strSystemCaptcha.equals(strUserCaptcha)){
        	/*Converting Base64*/
        	...
        	try{
        		...
        		strConvertedPass=decoder.decodeBuffer(userPass);
        		String decodeString=new String(strConvertedPass);
        		//System.out.println("Conversion 1 Login Page:"+decodeString);
        		strPassKey=decoder.decodeBuffer(decodeString);
        		//System.out.println("Conversion 2 Login Page:"+new String(strPassKey));
        	}catch(Exception e){
        		//System.out.println("Error::"+e.getMessage());
        		e.printStackTrace();
        	}
        	///session.setMaxInactiveInterval(30*60);
      		///Cookie loggedInUserCookie = new Cookie("loggedInUser", loggedInUser);
      		///loggedInUserCookie.setMaxAge(30*60);
      		///response.addCookie(loggedInUserCookie);
      		//Change 2 Added By Parmanand Start 22-05-2020 End
            ...
            //System.out.println((new StringBuilder()).append("userId:").append(userId).toString());
                 ...
                 if((String)dynaActionForm.get("password")!=null){
            	  String password = new String(strPassKey);
            	  String ipAddress = "";
                  String hostName = "";
                  String proxyName = "";
                  String sessionId = "";
                  String strRandomNumber=((String)session.getAttribute("randomNumber"))!=null?(String)session.getAttribute("randomNumber"):"";
                  try
                  {
                	  password = password.replaceAll(strRandomNumber,"");
              ...
              session.setAttribute("memberId", memberId);
                  ...
                  Log.log(5, "LoginAction", "login", (new StringBuilder()).append("ip address ").append(ipAddress).toString());
                  Log.log(5, "LoginAction", "login", (new StringBuilder()).append("host name ").append(hostName).toString());
                  Log.log(5, "LoginAction", "login", (new StringBuilder()).append("proxy name ").append(proxyName).toString());
                  Log.log(5, "LoginAction", "login", (new StringBuilder()).append("session id ").append(sessionId).toString());
                  Log.log(5, "LoginAction", "login", (new StringBuilder()).append("user id ").append(userId).toString());
                  if(shortName == null)
                  {
        ...
        return mapping.findForward(targetValue);
    ...
    private ArrayList setMainMenu(HttpServletRequest request)
    {
        ...
        if(menuIcon != null)
        {
            ...
            if(menuIcon.equals("DB"))
            {
            	
                if(userPrivileges.contains("AD_MLI_DEFINE_ORG_DASHBOARD"))
                {
                    mainMenus.add(MenuOptions.getMenu("AD_MLI_DEFINE_ORG_DASHBOARD"));
    				mainMenuValues.add(MenuOptions.getMenuAction("AD_MLI_DEFINE_ORG_DASHBOARD"));
    				mainMenus.add(MenuOptions.getMenu("AD_MLI_DEFINE_ORG_DASHBOARD_MLIR"));
    				mainMenuValues.add(MenuOptions.getMenuAction("AD_MLI_DEFINE_ORG_DASHBOARD_MLIR"));
            ...
            if(menuIcon.equals("RS"))
            {
                ...
                mainMenus.add(MenuOptions.getMenu("RS_VIEW_INVOICE"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_VIEW_INVOICE"));
                
                mainMenus.add(MenuOptions.getMenu("RS_DASHBOARD"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_DASHBOARD"));
                
                mainMenus.add(MenuOptions.getMenu("RS_SUMMARYREPORT"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_SUMMARYREPORT"));
                
                
                
                mainMenus.add(MenuOptions.getMenu("RS_GSTREPORT"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_GSTREPORT"));
                
                mainMenus.add(MenuOptions.getMenu("RS_DETAILSUMMARYREPORT"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_DETAILSUMMARYREPORT"));
                
                mainMenus.add(MenuOptions.getMenu("RS_NPAMARKINGCLAIMREPORT"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_NPAMARKINGCLAIMREPORT"));
                
                //DIKSHA 15072020
               /* mainMenus.add(MenuOptions.getMenu("RS_BULKUPLOAD_APPLICATION_DETAILS"));
                mainMenuValues.add(MenuOptions.getMenuAction("RS_BULKUPLOAD_APPLICATION_DETAILS"));*/
                
              /* // mainMenus.add(MenuOptions.getMenu("RS_SEARCH_HISTORY"));
				//mainMenuValues.add(MenuOptions
					//	.getMenuAction("RS_SEARCH_HISTORY"));
				
				// mainMenus.add(MenuOptions.getMenu("RS_CUMULATIVE_REPORT"));
 				mainMenuValues.add(MenuOptions
 						.getMenuAction("RS_CUMULATIVE_REPORT"));
 				 mainMenus.add(MenuOptions.getMenu("RS_BULKFILE_DOWNLOAD"));

                 mainMenuValues.add(MenuOptions.getMenuAction("RS_BULKFILE_DOWNLOAD"));*/
                if(userPrivileges.contains("REPORTS"))
                {
					 ...
					 * 
					 * mainMenus.add(MenuOptions.getMenu("RS_CUMULATIVE_REPORT"));
					 * mainMenuValues.add(MenuOptions .getMenuAction("RS_CUMULATIVE_REPORT"));
					 */
					/*
                ...
                } else
                {
                    ...
                    mainMenus.add(MenuOptions.getMenu("RS_QUERY_REPORT_INPUT"));              //Diksha 
                    mainMenuValues.add(MenuOptions.getMenuAction("RS_QUERY_REPORT_INPUT"));   //Diksha
                }*/
                }
            } else
            if(menuIcon.equals("AD"))
            {
				 ...
				 * userPrivileges.contains("MODIFY_COLLECTING_BANK_DETAILS")) {
                ...
                if(userPrivileges.contains("REGISTER_MLI") || userPrivileges.contains("ASSIGN_COLLECTING_BANK") || userPrivileges.contains("MODIFY_COLLECTING_BANK") || userPrivileges.contains("DEFINE_ORGANIZATION_STRUCTURE") || userPrivileges.contains("DEACTIVATE_MEMBER") || userPrivileges.contains("ACTIVATE_MEMBER"))
                {
                    ...
                    // ADDED BY DKR   Line No.  250
                  /*  mainMenus.add(MenuOptions.getMenu("RS_APPLICATION_STATUS_CBR"));                             //  < ------ Added by me
                    mainMenuValues.add(MenuOptions.getMenuAction("RS_APPLICATION_STATUS_CBR"));  */                //  < ------ Added by me 
                    // END
                }
				/*
            ...
            else if(menuIcon.equals("RAP")) //add by archana
            {
            ...
            if(menuIcon.equals("RP"))
            {
                ...
                if(userPrivileges.contains("ALLOCATE_PAYMENTS"))
                {
                  ...
                  /*  mainMenus.add(MenuOptions.getMenu("ASF_PAYMENT_THROUGH_NEFT_OR_RTGS"));
                    ...
                    mainMenus.add(MenuOptions.getMenu("RP_APPROPRIATE_RECOVERY"));
           		 	mainMenuValues.add(MenuOptions.getMenuAction("RP_APPROPRIATE_RECOVERY"));
                }
                if(userPrivileges.contains("APPROPRIATE_RECOVERY"))
                {
                	mainMenus.add(MenuOptions.getMenu("RP_APPROPRIATE_RECOVERY"));
           		 	mainMenuValues.add(MenuOptions.getMenuAction("RP_APPROPRIATE_RECOVERY"));
                }
            ...
            if(menuIcon.equals("AP"))
            {
                if(userPrivileges.contains("ADD_APPLICATION"))
                {
                    ...
                    mainMenus.add(MenuOptions.getMenu("AP_NPA_MARKING"));
                    mainMenuValues.add(MenuOptions.getMenuAction("AP_NPA_MARKING"));
                    
                    
                    mainMenus.add(MenuOptions.getMenu("AP_CLAIM_PROCESSING"));
                    mainMenuValues.add(MenuOptions.getMenuAction("AP_CLAIM_PROCESSING"));
                }
				/*
				 ...
				 * 
				 * // New Bulkupload mainMenus.add(MenuOptions.getMenu("AP_FILE_UPLOAD_NEW"));
				 * mainMenuValues.add(MenuOptions.getMenuAction("AP_FILE_UPLOAD_NEW")); // New
				 * Bulkupload
				 */
          // Excel Upload DKR APR Start      
              /*  mainMenus.add(MenuOptions.getMenu("AP_FILE_UPLOAD_2FCr"));
                mainMenuValues.add(MenuOptions.getMenuAction("AP_FILE_UPLOAD_2FCr"));
                
                
                mainMenus.add(MenuOptions.getMenu("AP_MUDRA_FILE_UPLOAD_2FCr"));
                mainMenuValues.add(MenuOptions.getMenuAction("AP_MUDRA_FILE_UPLOAD_2FCr"));*/
         // END      
    ...
    private void setSubMenu(String menuIcon, String mainMenu, HttpServletRequest request)
    {
        ...
        if(menuIcon != null)
        {
            ...
            if(menuIcon.equals("RS"))
            {
            	if(mainMenu.equals(MenuOptions.getMenu("RS_NPAMARKINGCLAIMREPORT")))
            	{
            		subMenus.add(MenuOptions.getMenu("RS_NPAMARKINREPORT"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_NPAMARKINREPORT"));
                    
                    if(bankID.equals("0000") && zoneID.equals("0000") && branchID.equals("0000"))
                    {
                    	subMenus.add(MenuOptions.getMenu("RS_MLICHECKERREPORT"));
                        subMenuValues.add(MenuOptions.getMenuAction("RS_MLICHECKERREPORT"));
                    }
                    subMenus.add(MenuOptions.getMenu("RS_BANKMANDATEREPORT"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_BANKMANDATEREPORT"));
                    
                    subMenus.add(MenuOptions.getMenu("RS_MLIRECOVERYREPORT"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_MLIRECOVERYREPORT"));
                    
                    subMenus.add(MenuOptions.getMenu("RS_CLAIMREPORT"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_CLAIMREPORT"));
                    
                    subMenus.add(MenuOptions.getMenu("RS_CLAIMPAYMENTREPORT"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_CLAIMPAYMENTREPORT"));
            	}
                ...
                if(mainMenu.equals(MenuOptions.getMenu("RS_CLAIMS_DETAILS")))
                {
                    ...
                    subMenus.add(MenuOptions.getMenu("RS_CLAIM_RECOVERY_DETAILS"));
                    subMenuValues.add(MenuOptions.getMenuAction("RS_CLAIM_RECOVERY_DETAILS"));
            ...
            if(menuIcon.equals("AD"))
            {
               /* if(mainMenu.equals(MenuOptions.getMenu("AD_COLLECTING_BANK")))
            	...
            	if (branchID.equals("0000") && zoneID.equals("0000") && !bankID.equals("0000")) // Show only to HO
				{
					subMenus.add(MenuOptions.getMenu("AD_USER_MGMT_CREATE_MLI_USER_NEW"));
					subMenuValues.add(MenuOptions.getMenuAction("AD_USER_MGMT_CREATE_MLI_USER_NEW"));
				}
            	else
            	{
            		if(!userPrivileges.contains("CREATE_MLI_USER")){
                		subMenus.add(MenuOptions.getMenu("AD_USER_MGMT_SHOW_MLI_USER_NEW"));
                		subMenuValues.add(MenuOptions.getMenuAction("AD_USER_MGMT_SHOW_MLI_USER_NEW"));}
            	}
                if(mainMenu.equals(MenuOptions.getMenu("AD_MLI")))
				{
					 ...
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AD_MLI_ASSIGN_CB")); }
					 * if(userPrivileges.contains("MODIFY_COLLECTING_BANK")) {
					 * subMenus.add(MenuOptions.getMenu(
					 * "AD_MLI_MODIFY_COLLECTING_BANK"));
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AD_MLI_MODIFY_COLLECTING_BANK")) ; }
					 */
					if (userPrivileges.contains("MODIFY_COLLECTING_BANK")) {
					 ...
					 * subMenus.add(MenuOptions.getMenu(
					 * "AD_MLI_DEACTIVATE_MEMBER"));
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AD_MLI_DEACTIVATE_MEMBER")); }
					 * if(userPrivileges.contains("ACTIVATE_MEMBER")) {
					 * subMenus.add(MenuOptions.getMenu(
					 * "AD_MLI_REACTIVATE_MEMBER"));
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AD_MLI_REACTIVATE_MEMBER")); }
					 */
				} else
            ...
            if(menuIcon.equals("AP"))
            {
                if(mainMenu.equals(MenuOptions.getMenu("AP_GUARANTEE_FOR")))
                {
                	...
                	///diksha
					 ...
					 subMenus.add(MenuOptions.getMenu("AP_GF_TERM_LOAN"));
					  ...
					  subMenus.add(MenuOptions.getMenu("AP_GF_DSBURSEMENT"));
					  subMenuValues.add(MenuOptions.getMenuAction("AP_GF_DSBURSEMENT"));
					  
					  /*subMenus.add(MenuOptions.getMenu("AP_GF_NPA_UPDRADE"));
					  subMenuValues.add(MenuOptions.getMenuAction("AP_GF_NPA_UPDRADE"));*/
					  
					  					 /* subMenus.add(MenuOptions.getMenu("AP_GF_MUDRA_APP"));
					  subMenuValues.add(MenuOptions.getMenuAction("AP_GF_MUDRA_APP"));
					 */
					/*
                ...
                else if (mainMenu.equals(MenuOptions.getMenu("AP_NPA_MARKING"))){
             	   
					  subMenus.add(MenuOptions.getMenu("AP_NPA_MARKING_VAL"));//added by sadananda on date 11-05-2021
					  subMenuValues.add(MenuOptions.getMenuAction("AP_NPA_MARKING_VAL"));
					  
					  subMenus.add(MenuOptions.getMenu("AP_GF_NPA_UPDRADE"));
					  subMenuValues.add(MenuOptions.getMenuAction("AP_GF_NPA_UPDRADE"));
              }
                else if (mainMenu.equals(MenuOptions.getMenu("AP_CLAIM_PROCESSING"))){
					  
                	if(bankID.equals("0000") && zoneID.equals("0000") && branchID.equals("0000"))
					  {
						  subMenus.add(MenuOptions.getMenu("AP_CLAIM_PROCESSING_APPROVAL"));//added by sadananda on date 21-05-2021
						  subMenuValues.add(MenuOptions.getMenuAction("AP_CLAIM_PROCESSING_APPROVAL"));
						  
						  subMenus.add(MenuOptions.getMenu("AP_BANK_APPROVAL"));
						  subMenuValues.add(MenuOptions.getMenuAction("AP_BANK_APPROVAL"));
						  
						  subMenus.add(MenuOptions.getMenu("AD_CLAIM_PAYMENT"));
						  subMenuValues.add(MenuOptions.getMenuAction("AD_CLAIM_PAYMENT"));
					  ...
					  {
						  subMenus.add(MenuOptions.getMenu("AP_CLAIM_PROCESSING_VAL"));//added by sadananda on date 21-05-2021
						  subMenuValues.add(MenuOptions.getMenuAction("AP_CLAIM_PROCESSING_VAL"));
						  
						  subMenus.add(MenuOptions.getMenu("AP_BANK_MANDATE"));
						  subMenuValues.add(MenuOptions.getMenuAction("AP_BANK_MANDATE"));
						  
						  subMenus.add(MenuOptions.getMenu("AP_MLI_CLAIM_RECOVERY"));
						 subMenuValues.add(MenuOptions.getMenuAction("AP_MLI_CLAIM_RECOVERY"));
						 
						 subMenus.add(MenuOptions.getMenu("AP_CLAIM_PROCESSING_SECOND_VAL"));//added by sadananda on date 23-06-2021
						  subMenuValues.add(MenuOptions.getMenuAction("AP_CLAIM_PROCESSING_SECOND_VAL"));
					  }  
                ...
                if(mainMenu.equals(MenuOptions.getMenu("AP_APPROVAL")))
                {
					 ...
					 * else if(mainMenu.equals(MenuOptions.getMenu("AP_APPROVAL_SPECIAL_MESSAGE")))
					 * { subMenus.add(MenuOptions.getMenu("AP_APPROVAL_SPECIAL_MESSAGE_INSERT"));
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AP_APPROVAL_SPECIAL_MESSAGE_INSERT"));
					 * subMenus.add(MenuOptions.getMenu("AP_APPROVAL_SPECIAL_MESSAGE_UPDATE"));
					 * subMenuValues.add(MenuOptions.getMenuAction(
					 * "AP_APPROVAL_SPECIAL_MESSAGE_UPDATE")); } else
            ...
            if(menuIcon.equals("CP"))
            {
                if(mainMenu.equals(MenuOptions.getMenu("CP_CLAIM_FOR")))
                {
                   ...
                   //String bankID = user.getBankId();
                    ...
                    subMenus.add(MenuOptions.getMenu("CP_CLAIM_FOR_FINAL_SETTELMENT"));
                    subMenuValues.add(MenuOptions.getMenuAction("CP_CLAIM_FOR_FINAL_SETTELMENT"));
            ...
            else if(menuIcon.equals("RAP")) //add by archana
            {
                ...
                {
                    subMenus.add(MenuOptions.getMenu("RAP_ALLOCATE_PAYMENTS_ONLINE"));
                    subMenuValues.add(MenuOptions.getMenuAction("RAP_ALLOCATE_PAYMENTS_ONLINE"));
                    subMenus.add(MenuOptions.getMenu("RAP_ALLOCATE_PAYMENTS_ONLINE_FINAL"));
                    subMenuValues.add(MenuOptions.getMenuAction("RAP_ALLOCATE_PAYMENTS_ONLINE_FINAL"));
                }
            ...
            if(menuIcon.equals("RP"))
            {
            	if (mainMenu.equals(MenuOptions.getMenu("RP_APPROPRIATE_RECOVERY")))
            	{
            		if(("0000").equals(bankID) && "0000".equals(zoneID) && "0000".equals(branchID))
            		{
            			subMenus.add(MenuOptions.getMenu("RP_RECOVERY_VAL"));
      				    subMenuValues.add(MenuOptions.getMenuAction("RP_RECOVERY_VAL"));
            		}
            		else
            		{
            			subMenus.add(MenuOptions.getMenu("RP_UTR_UPDATE"));
    				    subMenuValues.add(MenuOptions.getMenuAction("RP_UTR_UPDATE"));
            		}
               	}
                ...
                {
                   // Diksha  subMenus.add(MenuOptions.getMenu("RP_GUARANTEE_FEE"));
                   // Diksha subMenuValues.add(MenuOptions.getMenuAction("RP_GUARANTEE_FEE"));
