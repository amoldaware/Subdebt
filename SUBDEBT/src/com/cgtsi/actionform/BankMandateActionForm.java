...
public class BankMandateActionForm extends ValidatorActionForm {
	...
	private int flag;
	private LinkedHashMap<String,String> bankMandateList;
	private String userDetailData;
	private String cgtms_userId;
	
	
	public String getCgtms_userId() {
		return cgtms_userId;
	}

	public void setCgtms_userId(String cgtms_userId) {
		this.cgtms_userId = cgtms_userId;
	}
	...
	public LinkedHashMap<String, String> getBankMandateList() {
		return bankMandateList;
	}

	public void setBankMandateList(LinkedHashMap<String, String> bankMandateList) {
		this.bankMandateList = bankMandateList;
	}
	...
	public void setChecker_status(String checker_status) {
		this.checker_status = checker_status;
	}

	ArrayList<String> bankMandateErr;

	public ArrayList<String> getBankMandateErr() {
		return bankMandateErr;
	}

	public void setBankMandateErr(ArrayList<String> bankMandateErr) {
		this.bankMandateErr = bankMandateErr;
	}
