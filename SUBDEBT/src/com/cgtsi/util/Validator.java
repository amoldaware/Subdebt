...
public class Validator implements Serializable {
	...
	static double maxApprovedAmt = 50000000D;
	...
	public static boolean verifyBankTypeAndApproveLoanAmountForWcEnhancement(String loanType, String creditGuaranteed,
		...
		try {
			...
			if (validationFlag == true) {
				...
				// totalAmount"+totalAmount );
				double rrbValue = 50000000.0D;
				double fIValue = 50000000.0D;
...
//DIKSHA
	  ...
	  public static boolean validatePromoterMobileNo(Object bean, ValidatorAction
	  validAction, Field field, ActionErrors errors, HttpServletRequest request) {
		...
		if (proMobileNo == null || proMobileNo == 0) {
			error = new ActionError("mobileError");
	...
	public static boolean validateSanctionedDates(Object bean, ValidatorAction validAction, Field field,
		...
		if (!GenericValidator.isBlankOrNull(fromValue)) {
			...
			if (fromDateValue && toDateValue && DateHelper.day1BeforeDay2(fromValue, toValue)) {
				...
				ActionError actionMessage = new ActionError("sanctionDateValidation"+toValue);
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionMessage);
			}
	...
	/*public static boolean mudraITPANChkValue(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) {
		System.out.println("mudraITPANChk===");
		DynaActionForm dynaForm = (DynaActionForm) bean;
		String firmITPan = (String) dynaForm.get("ssiITPan");
		System.out.println("firmITPan==="+firmITPan);
		if (firmITPan!=null)
		{
			try {
				validateITPAN(bean,validAction,field,errors,request);
	...
	public static boolean validateCPITPAN(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws DatabaseException {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		boolean cpItPanFlag = false;
		System.out.println("===validateCPITPAN====");
		ActionError error = null;
		String cpITPAN = (String) dynaForm.get("cpITPAN");
		String cpITPAN1=(String) dynaForm.get("cpITPAN1");
		String cpITPAN2=(String) dynaForm.get("cpITPAN2");
		String cpITPAN3=(String) dynaForm.get("cpITPAN3");
		String cpITPAN4=(String) dynaForm.get("cpITPAN4");
		String cpITPAN5=(String) dynaForm.get("cpITPAN5");
		String cpITPAN6=(String) dynaForm.get("cpITPAN6");
		String cpITPAN7=(String) dynaForm.get("cpITPAN7");
		String cpITPAN8=(String) dynaForm.get("cpITPAN8");
		String cpITPAN9=(String) dynaForm.get("cpITPAN9");
		String socialCategory=(String) dynaForm.get("socialCategory");
		
		
		
		
		System.out.println("cpITPAN ==" + cpITPAN);
		
		System.out.println("cpITPAN2 ==" + cpITPAN2);
		
		if(socialCategory.equals(null)||socialCategory.equals(""))
		{
			error = new ActionError("socialCategoryError");
			errors	.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
	...
	if(cpITPAN!= null)
		{
			...
			if (matcher.matches()) {
				...
				error = new ActionError("ITPANMisMatch");
				errors	.add("org.apache.struts.action.GLOBAL_ERROR", error);
...
/*	if(cpITPAN1.length()>0)
	{
		System.out.println("cpITPAN2==1133=="+cpITPAN1);
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN2);

		if (matcher.matches()) {
			
			System.out.println("cpITPAN2==1139=="+cpITPAN1);
			//}
			

		} else {
			System.out.println("cpITPAN2==1144=="+cpITPAN1);
			error = new ActionError("ITPANMisMatch2");
			errors	.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	/*if(cpITPAN2!= null ||cpITPAN2!=""|| !cpITPAN2.equals(""))
	{
		System.out.println("NULL ERROR==="+cpITPAN2);
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN1);
	...
	*/
	...
	if(cpITPAN1!= null ||cpITPAN1!="")
	{
		...
		if (matcher.matches()) {
			...
			error = new ActionError("ITPANMisMatch1");
			errors	.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	if(cpITPAN3!= null ||cpITPAN3!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN3);
	...
	if(cpITPAN4!= null||cpITPAN4!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN4);
	...
	if(cpITPAN5!= null ||cpITPAN5!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN5);
	...
	if(cpITPAN6!= null ||cpITPAN6!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN6);
	...
	if(cpITPAN7!= null ||cpITPAN7!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN7);
	...
	if(cpITPAN8!= null ||cpITPAN8!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN8);
	...
	if(cpITPAN9!= null ||cpITPAN9!="")
	{
		Pattern pattern = Pattern.compile("[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
		Matcher matcher = pattern.matcher(cpITPAN9);
...
*/
	...
	public static boolean validateITPAN(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws DatabaseException {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		boolean cpItPanFlag = false;
		System.out.println("===validateITPAN====");
		ActionError error = null;
		String firmITPan = (String) dynaForm.get("ssiITPan");
		String cpITPAN = (String) dynaForm.get("cpITPAN");
		String constitution = (String) dynaForm.get("constitution");
		

		double appApprovedAmt=0.0;

		System.out.println("ssiITPan ==" + firmITPan);
		System.out.println("cpITPAN ==" + cpITPAN);
		System.out.println("coString cpITPANion ==" + constitution);

		boolean itPanFlag = false;
		
	
		if (firmITPan == null || firmITPan.equals("") ) { //
			error = new ActionError("firmITPanRequired");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		} else if("Proprietary/Individual".equals(constitution)){
			...
			if (matcher.matches()) {
				...
				error = new ActionError("firmITPanInvalid");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		 ...
		 else if("Partnership".equals(constitution)){
		 ...
		 else if("Limited liability Partnership".equals(constitution)){
		 ...
		 else if("private".equals(constitution)){
		 ...
		 else if("public".equals(constitution)){
		 ...
		 else if("HUF".equals(constitution)){
		 ...
		 else if("Trust".equals(constitution)){
		 ...
		 else if("Society/Co op".equals(constitution)){
				
				Pattern pattern = Pattern.compile("[a-zA-Z]{3}[aAbB]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
				Matcher matcher = pattern.matcher(firmITPan);
	...
	public static boolean validateIntrestRate(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws DatabaseException {
		Application application = new Application();
		
		DynaActionForm dynaForm = (DynaActionForm) bean;
		HttpSession session = request.getSession(false);
		System.out.println("=====validateIntrestRate==");
		
	
		String memberId = (String) session.getAttribute("memberId");
		System.out.println("member id=="+memberId);
		// memberId = (String) dynaForm.get("selectMember");
		
		Double interestRate = (Double) dynaForm.get("interestRate");
		ActionError error = null;
		
		System.out.println("validator===member id=="+memberId);
		int memIdType = objApplicationDAO.getMemIdType(memberId);
				System.out.println("memIdType=="+memIdType);
					if (memIdType > 0) {
						if(interestRate>14D)
						{
						System.out.println("memIdType==="+memIdType);
						error = new ActionError("nbfcIntrestRate");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
						}
					}
					else if (interestRate>9.25D)
							{
							System.out.println("memIdType==="+memIdType);
							error = new ActionError("mliIntrestRate");
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
							}
	...
	public static boolean checkCoveredValue(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========checkCoveredValue================RRRRRR");
		//ActionError error = null;
		double turnOverVal = (Double) dynaForm.get("projectedSalesTurnover");
		
		System.out.println("projectedSalesTurnover"+turnOverVal);
		...
		if (cgtsiCoveredValue.equals("Y")) {
			 ...
			 * ActionError("cpitpan"); errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); }
			 */
			ActionError error = null;
			boolean cpItPanFlag = false;
			 ...
			 * String constituition = (String) dynaForm.get("constitution");
			 * 
			 * // String firstItpan = (String)dynaForm.get("firstItpan"); //String
			 * secondItpan = (String) //dynaForm.get("secondItpan"); String firstName =
			 * (String) // dynaForm.get("firstName"); String secondName = (String)
			 * //dynaForm.get("secondName"); String firmITPan = (String)
			 * dynaForm.get("ssiITPan"); double creditGuaranteed =
			 * (Double)dynaForm.get("pplOS"); //Date firstDOB = (Date) //
			 * dynaForm.get("firstDOB"); String firstDob = firstDOB.toString(); Date
			 * secondDOB = (Date) dynaForm.get("secondDOB"); String secondDob =
			 * secondDOB.toString();
			 * System.out.println("Out Standing amt =="+creditGuaranteed); // boolean
			 * itPanFlag=false; if(creditGuaranteed>=5000000.0D) { itPanFlag=true;
			 * 
			 * }//creditFundBased
			 * 
			 * if (("Proprietary/Individual".equals(constituition)&&
			 * itPanFlag)||"Proprietary/Individual".equals(constituition)) { if(cpITPAN ==
			 * null || cpITPAN.equals("")) { cpItPanFlag = true; error = new
			 * ActionError("cpitpan"); errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN); if (!matcher.matches()) { error = new
			 * ActionError("cpITPAN"); errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); } }
			 * 
			 * } else if(("Partnership".equals(constituition)&&
			 * itPanFlag)||"Partnership".equals(constituition)) { if (cpITPAN == null ||
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else { Pattern
			 * pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN);
			 * 
			 * if (!matcher.matches()) { error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } if (firmITPan
			 * == null || firmITPan.equals("")) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 ...
			 * 
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", new
			 * ActionError("firmITPanInvalid")); } System.out.println(creditGuaranteed+
			 * "..................creditGuaranteed"); } } else
			 * if(("Limited liability Partnership".equals(constituition)&&
			 * itPanFlag)||"Limited liability Partnership".equals(constituition) ) { if
			 * (!cpITPAN.trim().equals("")) { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 ...
			 * 
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("cpITPAN")); }} else if(("private".equals(constituition)&&
			 * itPanFlag)||"private".equals(constituition)) { if (cpITPAN == null ||
			 * cpITPAN.equals("")) { cpItPanFlag = true;
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else { Pattern
			 ...
			 * if (matcher.matches()) {
			 * 
			 * } else { errors.add("org.apache.struts.action.GLOBAL_ERROR", new
			 * ActionError("cpITPAN")); error =new ActionError("cpITPAN");
			 ...
			 * ("public".equals(constituition)) { if (cpITPAN == null || cpITPAN.equals(""))
			 * { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else { Pattern
			 * pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[cC]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN); if (matcher.matches()) { } else { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("cpITPAN")); error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }}}
			 * 
			 ...
			 * ("HUF".equals(constituition)) { if (cpITPAN == null || cpITPAN.equals("")) {
			 * cpItPanFlag = true; error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[hH]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 * if(itPanFlag){ if (!firstItpan.trim().equals("")) { Pattern pattern =
			 * Pattern.compile( "[a-zA-Z]{3}[hH]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 ...
			 * //System.out.println("Sorry..................................."); error = new
			 * ActionError("firstItpann");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (!secondItpan.trim().equals("")) { Pattern pattern = Pattern.compile(
			 * "[a-zA-Z]{3}[hH]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(secondItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if (firstName
			 * == null || firstName.equals("")) {
			 * 
			 ...
			 * 
			 * } if (!(firstItpan == null || firstItpan.equals("")) && !(secondItpan == null
			 * || secondItpan.equals(""))) { if (firstItpan.equals(secondItpan)) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 ...
			 * 
			 * } else { // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobfirstNameInvalid")); error = new
			 ...
			 * ("Trust".equals(constituition)) { if (cpITPAN == null || cpITPAN.equals(""))
			 * { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[tT]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 ...
			 * (!firstItpan.trim().equals("")) { Pattern pattern = Pattern.compile(
			 * "[a-zA-Z]{3}[tT]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 * = pattern.matcher(firstItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("firstItpan");
			 ...
			 * 
			 * if (!cpITPAN.trim().equals("")) { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[abAB]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher
			 * matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("cpITPAN");
			 ...
			 * (!firstItpan.trim().equals("")) { Pattern pattern = Pattern.compile(
			 * "[a-zA-Z]{3}[abAB]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher
			 * matcher = pattern.matcher(firstItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("firstItpan");
			 ...
			 * (!secondItpan.trim().equals("")) { Pattern pattern = Pattern.compile(
			 * "[a-zA-Z]{3}[abAB]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher
			 * matcher = pattern.matcher(secondItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("secondItpan");
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } // ====== End
			 * =====
			 */
			 ...
			 * secondDOB = (Date) dynaForm.get("secondDOB"); String secondDob =
			 * secondDOB.toString();
			 * System.out.println("CreditGuaranteed =="+creditGuaranteed); //boolean
			 * itPanFlag=false; if(creditGuaranteed>=5000000.0D){ itPanFlag=true;
			 * }//creditFundBased
			 * 
			 * if (("Proprietary/Individual".equals(constituition)&&
			 ...
			 * = pattern.matcher(cpITPAN); if (!matcher.matches()) { error = new
			 * ActionError("cpITPAN"); errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); } } if (firmITPan == null || firmITPan.equals("")) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("firmITPanRequired")); error = new
			 * ActionError("firmITPanRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else { Pattern
			 ...
			 * 
			 * error = new ActionError("firstNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if (secondName
			 * == null || secondName.equals("")) {
			 * 
			 * error = new ActionError("secondNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 ...
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } } } else
			 * if(("HUF".equals(constituition)&& itPanFlag)||"HUF".equals(constituition)) {
			 * //if ("HUF".equals(constituition)) { if (cpITPAN == null ||
			 * cpITPAN.equals("")) { cpItPanFlag = true; error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[hH]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}"); Matcher matcher
			 ...
			 * dynaForm.get("activityType").equals("")) { error = new
			 * ActionError("errors.required", "Activity Type");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 */
			 ...
			 * dynaForm.get("cpFirstName").equals("")) { error = new
			 * ActionError("errors.required", "Chief Promoter First Name");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpLastName") == null || dynaForm.get("cpLastName").equals(""))
			 * { error = new ActionError("errors.required",
			 ...
			 * dynaForm.get("otherCpLegalID").equals("")) { Log.log(4, "Validator",
			 * "checkLegalId", "Legal Id Other is not entered"); error = new
			 * ActionError("legalIdRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else if
			 * (dynaForm.get("otherCpLegalID") != null &&
			 * !dynaForm.get("otherCpLegalID").equals("") && (dynaForm.get("cpLegalIdValue")
			 * == null || dynaForm.get("cpLegalIdValue").equals(""))) { error = new
			 * ActionError("errors.required", "Legal Id Value");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("cpLegalID") != null &&
			 * !dynaForm.get("cpLegalID").equals("Others") &&
			 * !dynaForm.get("cpLegalID").equals("") && (dynaForm.get("cpLegalIdValue") ==
			 * null || dynaForm.get("cpLegalIdValue").equals(""))) { error = new
			 * ActionError("errors.required", "Legal Id Value");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 ...
			 * dynaForm.get("otherSubsidyEquityName").equals(""))) { Log.log(4, "Validator",
			 * "checkSubsidyName", "Subsidy Name is not entered"); error = new
			 * ActionError("subsidyNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 */
			Administrator admin = new Administrator();
			...
			// DIKSHA
			/*
			 * if (dynaForm.get("cpITPAN") == null || dynaForm.get("cpITPAN").equals("")) if
			 ...
			 * "checkSubsidyName", "ITPAN is not entered"); error = new
			 * ActionError("errors.required", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("loanType").equals("CC") ||
			 ...
			 * Log.log(4, "Validator", "checkSubsidyName", "ITPAN is not entered"); error =
			 * new ActionError("errors.required", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("loanType").equals("WC") && ((Double)
			 * dynaForm.get("wcFundBasedSanctioned")).doubleValue() + ((Double)
			 * dynaForm.get("wcNonFundBasedSanctioned")).doubleValue() >= minAmount) {
			 * 
			 * Log.log(4, "Validator", "checkSubsidyName", "ITPAN is not entered"); error =
			 ...
			 * String itpan = (String) dynaForm.get("cpITPAN"); boolean itpanCheck = false;
			 * char array1[] = itpan.toCharArray(); if (array1.length == 10 &&
			 ...
			 * Character.isDigit(array1[8]) && Character.isLetter(array1[9])) { itpanCheck =
			 * true; } else { Log.log(4, "Validator", "checkSubsidyName",
			 * "ITPAN is not entered"); itpanCheck = false; error = new
			 * ActionError("errors.itpan", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 */
			// DIKSHA END
			/*
			 ...
			 * "constitution").equals("Others")) && (dynaForm.get("constitutionOther") ==
			 * null || dynaForm .get("constitutionOther").equals(""))) { Log.log(4,
			 * "Validator", "checkConstitution", "constituitionOther is not entered");
			 * ActionError error = new ActionError("constituitionRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("state") == null || dynaForm.get("state").equals("")) {
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * ((dynaForm.get("district") == null || dynaForm.get("district").equals("") ||
			 * dynaForm.get( "district").equals("Others")) &&
			 * (dynaForm.get("districtOthers") == null || dynaForm.get(
			 * "districtOthers").equals(""))) { Log.log(4, "Validator", "checkDistrict",
			 * "Distict Other is not entered"); ActionError error = new
			 * ActionError("districtRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("ssiType") == null || dynaForm.get("ssiType").equals("")) {
			 * ActionError error = new ActionError("errors.required", "Unit Type");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("ssiName") == null || dynaForm.get("ssiName").equals("")) {
			 ...
			 * dynaForm.get("projectedSalesTurnover").equals("")) { ActionError error = new
			 * ActionError("errors.required", "turnover");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("projectedExports") == null ||
			 * dynaForm.get("projectedExports").equals("")) { ActionError error = new
			 * ActionError("errors.required", "exports");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("activityType") == null ||
			 * dynaForm.get("activityType").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Activity Type");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("address") == null || dynaForm.get("address").equals("")) {
			 * ActionError error = new ActionError("errors.required", "Unit Address");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("pincode") == null || dynaForm.get("pincode").equals("")) {
			 * ActionError error = new ActionError("errors.required", "Pincode");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpTitle") == null || dynaForm.get("cpTitle").equals("")) {
			 ...
			 * (dynaForm.get("otherCpLegalID") == null ||
			 * dynaForm.get("otherCpLegalID").equals("")) { Log.log(4, "Validator",
			 * "checkLegalId", "Legal Id Other is not entered"); ActionError error = new
			 * ActionError("legalIdRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else if
			 * (dynaForm.get("otherCpLegalID") != null &&
			 * !dynaForm.get("otherCpLegalID").equals("") && (dynaForm.get("cpLegalIdValue")
			 * == null || dynaForm .get("cpLegalIdValue").equals(""))) { ActionError error =
			 * new ActionError("errors.required", "Legal Id Value");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("cpLegalID") != null &&
			 * !dynaForm.get("cpLegalID").equals("Others") &&
			 * !dynaForm.get("cpLegalID").equals("") && (dynaForm.get("cpLegalIdValue") ==
			 ...
			 * .get("otherSubsidyEquityName").equals(""))) { Log.log(4, "Validator",
			 * "checkSubsidyName", "Subsidy Name is not entered"); ActionError error = new
			 * ActionError("subsidyNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } Administrator
			 * admin = new Administrator(); ParameterMaster parameterMaster =
			 * admin.getParameter(); double minAmount =
			 * parameterMaster.getMinAmtForMandatoryITPAN(); SimpleDateFormat dateFormat =
			 * new SimpleDateFormat("dd/MM/yyyy"); Date fixDateForITPan=null; Date
			 * appSactionDate=null; Date fundBaseDateForITPan=null; Date
			 * nonFundBaseDateForITPan=null; Date maxDateForBothLoanType=null;
			 * SortedSet<Date> dates = new TreeSet<Date>(); try { fixDateForITPan
			 ...
			 * if(!dynaForm.get("amountSanctionedDate").toString().trim().equals ("")) {
			 * //System.out.println("amountSanctionedDate is not blank"); boolean
			 * flagAppTC=false; try { appSactionDate=dateFormat.parse(dynaForm.get(
			 * "amountSanctionedDate").toString()); } catch(Exception e) {
			 * //System.out.println("exception in"+e.getMessage()); flagAppTC=true; }
			 * //System.out.println("flagAppTC value"+flagAppTC); if(flagAppTC==false) {
			 * if(appSactionDate.compareTo(fixDateForITPan)>=0) { //
			 * System.out.println("sac date is greater than or equal"); minAmount=500000; }
			 * else { System.out.println("loanType is TC==");} } } } else
			 * if(dynaForm.get("loanType").equals("WC")) {
			 * if((!dynaForm.get("limitFundBasedSanctionedDate").toString().trim
			 * ().equals("")) &&
			 * (!dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim
			 * ().equals(""))) { //System.out.println("WC both are not blank"); boolean
			 * flagAppWC=false; try { fundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitFundBasedSanctionedDate").toString());
			 * nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception e) {
			 * flagAppWC=true; }
			 * 
			 * if(flagAppWC==false) {
			 * if(fundBaseDateForITPan.compareTo(nonFundBaseDateForITPan)==1) {
			 * if(fundBaseDateForITPan.compareTo(fixDateForITPan)>=0) { //
			 * System.out.println("date is greater than or equal"); minAmount=500000; } }
			 * else if(fundBaseDateForITPan.compareTo(nonFundBaseDateForITPan)==-1) {
			 * if(nonFundBaseDateForITPan.compareTo(fixDateForITPan)>=0) { //
			 * System.out.println("date is greater than or equal"); minAmount=500000; } }
			 * else if(fundBaseDateForITPan.compareTo(nonFundBaseDateForITPan)==0) {
			 ...
			 * 
			 * 
			 * } else if((dynaForm.get("limitFundBasedSanctionedDate").toString().trim(
			 * ).equals("")) &&
			 * (!dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim
			 * ().equals(""))) {
			 * //System.out.println("WC limitFundBasedSanctionedDate is blank"); boolean
			 * flagAppWC=false; try { nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception e) {
			 * flagAppWC=true; } //System.out.
			 ...
			 * (dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim(
			 * ).equals(""))) {
			 * //System.out.println("WC 1st is blank and 2nd is not blank"); boolean
			 * flagAppWC=false; try { fundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitFundBasedSanctionedDate").toString()); } catch(Exception e) {
			 * flagAppWC=true; }
			 * 
			 * if(flagAppWC==false) { if(fundBaseDateForITPan.compareTo(fixDateForITPan)>=0)
			 * { // System.out.println("date is greater than or equal"); minAmount=500000; }
			 * } }
			 * 
			 ...
			 * if(!dynaForm.get("amountSanctionedDate").toString().trim().equals ("")) {
			 * boolean flagAppTC=false; try { appSactionDate=dateFormat.parse(dynaForm.get(
			 * "amountSanctionedDate").toString()); } catch(Exception e) { flagAppTC=true; }
			 * 
			 * if(flagAppTC==false) { boolean flagAppBothValid=false;
			 * if((!dynaForm.get("limitFundBasedSanctionedDate").toString().trim
			 * ().equals("")) &&
			 * (!dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim
			 * ().equals(""))) { try { fundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitFundBasedSanctionedDate").toString());
			 * nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception e) {
			 * flagAppBothValid=true; }
			 ...
			 * dates.add(fundBaseDateForITPan); dates.add(nonFundBaseDateForITPan);
			 * 
			 ...
			 * get("limitNonFundBasedSanctionedDate")); if (dynaForm.get("cpITPAN") == null
			 ...
			 * 
			 * //System.out.println("Chief Promoter ITPAN"); Log.log(4, "Validator",
			 * "checkSubsidyName", "ITPAN is not entered"); ActionError error = new
			 * ActionError("errors.required", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("loanType").equals("CC") ||
			 * dynaForm.get("loanType").equals("BO")) { if (((Double)
			 * dynaForm.get("termCreditSanctioned")) .doubleValue() + ((Double)
			 * dynaForm.get("wcFundBasedSanctioned")) .doubleValue() + ((Double) dynaForm
			 * .get("wcNonFundBasedSanctioned")) .doubleValue() >= minAmount) { Log.log(4,
			 * "Validator", "checkSubsidyName", "ITPAN is not entered"); ActionError error =
			 * new ActionError("errors.required", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } } else if
			 * (dynaForm.get("loanType").equals("WC") && ((Double)
			 * dynaForm.get("wcFundBasedSanctioned")) .doubleValue() + ((Double) dynaForm
			 * .get("wcNonFundBasedSanctioned")) .doubleValue() >= minAmount) {
			 * 
			 * Log.log(4, "Validator", "checkSubsidyName", "ITPAN is not entered");
			 * ActionError error = new ActionError("errors.required",
			 * "Chief Promoter ITPAN"); errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); } if (dynaForm.get("cpITPAN") != null &&
			 * !dynaForm.get("cpITPAN").equals("")) { String itpan = (String)
			 * dynaForm.get("cpITPAN"); boolean itpanCheck = false; char array1[] =
			 * itpan.toCharArray(); if (array1.length == 10 && Character.isLetter(array1[0])
			 * && Character.isLetter(array1[1]) && Character.isLetter(array1[2]) &&
			 * Character.isLetter(array1[3]) && Character.isLetter(array1[4]) &&
			 * Character.isDigit(array1[5]) && Character.isDigit(array1[6]) &&
			 * Character.isDigit(array1[7]) && Character.isDigit(array1[8]) &&
			 * Character.isLetter(array1[9])) { itpanCheck = true; } else { Log.log(4,
			 * "Validator", "checkSubsidyName", "ITPAN is not entered"); itpanCheck = false;
	 ...
	 * DynaActionForm dynaForm = (DynaActionForm) bean; String loanType = (String)
	 * dynaForm.get("loanType"); HttpSession session = request.getSession(false);
	 * Double wcFBVal = new Double(ValidatorUtil.getValueAsString(bean,
	 * field.getProperty())); double wcFBValue = wcFBVal.doubleValue(); String
	 * wcNFBSanctioned = field.getVarValue("wcNFB"); Double wcNFBSanctionedVal = new
	 * Double(ValidatorUtil.getValueAsString(bean, wcNFBSanctioned)); double
	 * wcNFBSanctionedValue = wcNFBSanctionedVal.doubleValue(); String
	 * wcPromoterCont = field.getVarValue("wcPCont"); Double wcPromoterContVal = new
	 * Double(ValidatorUtil.getValueAsString(bean, wcPromoterCont)); double
	 * wcPromoterContValue = wcPromoterContVal.doubleValue(); String wcSubsidyEquity
	 * = field.getVarValue("wcSubsidy"); Double wcSubsidyEquityVal = new
	 * Double(ValidatorUtil.getValueAsString(bean, wcSubsidyEquity)); double
	 * wcSubsidyEquityValue = wcSubsidyEquityVal.doubleValue(); String others =
	 * field.getVarValue("wcOther"); Double wcOthersVal = new
	 * Double(ValidatorUtil.getValueAsString(bean, others)); double wcOthersValue =
	 * wcOthersVal.doubleValue(); Log.log(4, "Validator", "checkWcEntry", (new
	 * StringBuilder()).
	 * append("session.getAttribute(SessionConstants.APPLICATION_TYPE) :")
	 * .append(session.getAttribute("APPLICATION_TYPE")).toString()); if
	 * (loanType.equals("WC") || loanType.equals("CC") &&
	 ...
	 * loanType.equals("BO")) { Log.log(4, "Validator", "checkWcEntry", (new
	 * StringBuilder()).append("loan type :").append(loanType).toString()); if
	 * (wcFBValue == 0.0D && wcNFBSanctionedValue == 0.0D) { Log.log(4, "Validator",
	 * "checkWcEntry", "both WC Values not entered"); ActionError actionError = new
	 * ActionError("fbNFBRequired");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } } if
	 * ((wcPromoterContValue != 0.0D || wcSubsidyEquityValue != 0.0D ||
	 * wcOthersValue != 0.0D) && wcFBValue == 0.0D && wcNFBSanctionedValue == 0.0D)
	...
	public static boolean checkCreditAmtGreater(Object bean, ValidatorAction validAction, Field field,
		 ...
		 ActionError error=null;
			DynaActionForm dynaForm = (DynaActionForm) bean;
			Double osMLI = (Double) dynaForm.get("osMLI");
			Double osAmt = (Double) dynaForm.get("pplOS");
	
			
			if (osMLI >250000000D  ) {
				System.out.println("osAmt=="+osAmt);
				System.out.println("osMLI=="+osMLI);
				
				error = new ActionError("OSMLICross25Cr");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			...
			if (osAmt > 250000000D) {
				...
				error = new ActionError("OSAmtCross25Cr");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		...
		if (osMLI != 0.0D && osAmt != 0.0D && osMLI > osAmt) {
			System.out.println("osAmt=="+osAmt);
			System.out.println("osMLI=="+osMLI);
			
			error = new ActionError("osMLIError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	/*public static boolean checkCreditAmtGreater(Object bean, ValidatorAction validAction, Field field,
		...
		System.out.println("creditVal=="+creditVal);
		String creditString = field.getProperty();
		System.out.println("creditString=="+creditString);
		double creditValue = creditVal.doubleValue();
		System.out.println("credicreditValuetString=="+creditValue);
		String totalOsBureauVal = field.getVarValue("pplos");
		System.out.println("totalOsBureauVal=="+totalOsBureauVal);
		Double totalOsVal = new Double(ValidatorUtil.getValueAsString(bean, totalOsBureauVal));
		System.out.println("totalOsVal=="+totalOsVal);
		double totalOs = totalOsVal.doubleValue();
		System.out.println("totalOs=="+totalOs);
		if (creditValue != 0.0D && totalOs != 0.0D && creditValue > totalOs) {
			System.out.println("totalOsVal=="+totalOsVal);
...
*/
	...
	// DIKSHA
	/*
	 * public static boolean checkInstallmentEntry(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest request)
	 * throws Exception { Integer installmentVal = new
	 * Integer(ValidatorUtil.getValueAsString(bean, field.getProperty())); int
	 * installmentValue = installmentVal.intValue(); HttpSession session =
	 * request.getSession(false); if (session.getAttribute("APPLICATION_TYPE_FLAG")
	 * != null && (session.getAttribute("APPLICATION_TYPE_FLAG").equals("8") ||
	 * session.getAttribute("APPLICATION_TYPE_FLAG").equals("7") ||
	 * session.getAttribute("APPLICATION_TYPE_FLAG").equals("0") ||
	 * (session.getAttribute("APPLICATION_TYPE_FLAG").equals("14") ||
	 ...
	 * session.getAttribute("APPLICATION_LOAN_TYPE").equals("CC") ||
	 * session.getAttribute("APPLICATION_LOAN_TYPE").equals("BO"))) &&
	 * installmentValue == 0) { ActionError actionError = new
	 * ActionError("noOfInstallmentsrequired");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } return
	 * errors.isEmpty(); }
	 */
	...
	public static boolean checkAmtDisbursedGreater(Object bean, ValidatorAction validAction, Field field,
		...
		String creditString = field.getProperty();
		double creditValue = creditVal.doubleValue();
		String termCreditSanctionedVal = field.getVarValue("creditGuaranteed");
	...
	/*public static boolean validateCaptcha(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateCaptcha================");
		ActionError error = null;
		String inputText = (String) dynaForm.get("inputText"); //
		String captcha = (String) dynaForm.get("captcha");
		// String captcha=request.getParameter("captcha");

		System.out.println("inputText ==" + inputText);
		System.out.println("captcha ==" + captcha);

		if (inputText.equals(null) || inputText == "") {
			error = new ActionError("inputTextNull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}

		if (!inputText.equals(captcha)) {
			error = new ActionError("inputTextNotMatched");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	//Comemented By Parmanand 28052020
	public static boolean validateCaptcha(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateCaptcha================");
		...
		///String captcha = (String) dynaForm.get("captcha");
		// String captcha=request.getParameter("captcha");
	   String captcha = (String)request.getSession().getAttribute("captcha_key_name");
		System.out.println("inputText ==" + inputText);
		System.out.println("captcha >>>>>>>>>>>>>==" + captcha);
		...
		if (inputText!=null && captcha != null && !inputText.equals(captcha)){
			
			System.out.println(captcha+">>>>captVal>>>>>>>>>>>>DR>>>>>>>>>>>>>>>>>>>>>>>>>>captcha>>>>"+captcha);
			ActionError actionError = new ActionError("acptchaErrorNotMatch");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		} 
	...
	public static boolean validateEGSCreditSanction(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateEGSCreditSanction================");
		ActionError error = null;
		Double creditGuaranteed = (Double) dynaForm.get("creditGuaranteed");
		 if(creditGuaranteed>7500000D)
		 {
			 error = new ActionError("MinSubDebtValue");
			 errors.add("org.apache.struts.action.GLOBAL_ERROR", error); 
		 }
		Double disbursedAmt = (Double) dynaForm.get("disbursementAmt");
		
		System.out.println("disbursedAmt ==" + disbursedAmt);
		Double sanctionedAmt = (Double) dynaForm.get("pplOS");
		
		System.out.println("sanctionedAmt ==" + sanctionedAmt);
		Double sanctionedAmount = (Double) dynaForm.get("sanctionedAmount");
		

		if(sanctionedAmount!=null && sanctionedAmount>20000000)
		{
			System.out.println("sanctionedAmount=="+sanctionedAmount);
			
			error = new ActionError("sanctionedAmountCheck");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		String  cgpanVal = (String) dynaForm.get("cgpan");
		if(cgpanVal!=null && (!cgpanVal.equals("")||cgpanVal.length()>0))
		{
			System.out.println("cgpanVal=="+cgpanVal);
			
            Pattern pattern = Pattern.compile("CG[0-9]{11}[A-Z]{2}");
            System.out.println("pattern=="+pattern);
			
			Matcher matcher = pattern.matcher(cgpanVal);
			...
			else
			{
				...
				error = new ActionError("cgpanCheck");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
		...
		Double totalOutstandingAmt = (Double) dynaForm.get("totalOutstandingAmt");
		System.out.println("totalOutstandingAmt ==" + totalOutstandingAmt);
		Double otherBanktotalOutstandingAmt = (Double) dynaForm.get("otherBanktotalOutstandingAmt");
		System.out.println("otherBanktotalOutstandingAmt ==" + otherBanktotalOutstandingAmt);
		Double pmr15Percent = (Double) dynaForm.get("pmr15Percent");
		System.out.println("pmr15Percent ==" + pmr15Percent);
		//Double osAmt = (Double) dynaForm.get("pplOS");
		if(otherBanktotalOutstandingAmt==null)
		{
			otherBanktotalOutstandingAmt=0.0;
		}
		double minSubDebtValue=0.0D;
		double totalOs=otherBanktotalOutstandingAmt+totalOutstandingAmt;
		//Double wcOutstandingAmt = (Double) dynaForm.get("wcOutstandingAmt");
		//Double wcOutstandingAmt = (Double) dynaForm.get("wcOutstandingAmt");
		//Double wcOutstandingAmt = (Double) dynaForm.get("wcOutstandingAmt");
		...
		if (disbursedAmt >sanctionedAmt  ) {
			System.out.println("disbursedAmt=="+disbursedAmt);
			System.out.println("sanctionedAmt=="+sanctionedAmt);
			
			error = new ActionError("disburseCheck");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			
			
		}
		
		if (creditGuaranteed >sanctionedAmt  ) {
			System.out.println("sanctionedAmt=="+sanctionedAmt);
			System.out.println("creditGuaranteed=="+creditGuaranteed);
			
			error = new ActionError("subdebtAmtCheck");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			
			
		}
		
		//System.out.println("Out Standing amt ==" + osAmt);
		System.out.println("creditGuaranteed ==" + creditGuaranteed);
		//String amountValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		//String amountProperty = field.getProperty();
		//Double amountVal = new Double(amountValue);
		double amtValue = 0.0D;
		double maxMinVal=7500000D;
		double minValue=0.0D;

		/*
		 * if((creditGuaranteed==null ||creditGuaranteed==0.0D)) { error = new
		 * ActionError("creditGuaranteedNull");
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else
		  if(osAmt==null||osAmt==0.0D)
		{
			error = new ActionError("pplOSNull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}*/
		
		 minSubDebtValue=Math.min(pmr15Percent,totalOs );
		 System.out.println("minSubDebtValue==="+minSubDebtValue);
		 
		// minValue=Math.min(minSubDebtValue, maxMinVal);
		 System.out.println("minValue==="+minValue);
		 
		 if(creditGuaranteed>minSubDebtValue || creditGuaranteed>maxMinVal)
		 {
			 error = new ActionError("MinSubDebtValue");
			 errors.add("org.apache.struts.action.GLOBAL_ERROR", error); 
		 }
	...
	public static boolean validateEGSMudraSaction(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		HttpSession session = request.getSession(false);
		System.out.println("===========validateEGSMudraSaction===============");
		ActionError error = null;
		Double creditGuaranteed = (Double) dynaForm.get("creditGuaranteed");
		Double osAmt = (Double) dynaForm.get("pplOS");
		String mudraTypeVal = (String) dynaForm.get("mudraType");
		String loanAccNo = (String) dynaForm.get("bankAcNo");
		
		
		System.out.println("mudraTypeVal ==" + mudraTypeVal);
		...
		System.out.println("validator===member id=="+memberId);
		int mudraMaxLimit = objApplicationDAO.getmudraMaxLimit(memberId,mudraTypeVal,creditGuaranteed);
				System.out.println("mudraMaxLimit=="+mudraMaxLimit);
					if (mudraMaxLimit > 0) {
						
						System.out.println("mudraMaxLimit==="+mudraMaxLimit);
						error = new ActionError("mudraMaxLimitError");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					...
					int mudraLoanAccCnt = objApplicationDAO.getmudraLoanAccNo(loanAccNo);
					System.out.println("mudraLoanAccCnt=="+mudraLoanAccCnt);
						if (mudraLoanAccCnt > 0) {
							
							System.out.println("mudraLoanAccCnt==="+mudraLoanAccCnt);
							error = new ActionError("mudraLoanAccError");
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		...
		if(mudraTypeVal!=null || ! mudraTypeVal.equals(""))
		{
		if (mudraTypeVal.equals("SHISHU") ) {
			
			
			/*if (osAmt > 50000D) 
			{
				error = new ActionError("MudraShishuError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
			*/
			
			
			if(creditGuaranteed>10000D)
			{
		...
		if (mudraTypeVal.equals("KISHORE") ) {
			
		/*	if (osAmt > 500000D) 
			{
				error = new ActionError("MudraKishoreError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
			*/
					...
					if(creditGuaranteed>100000D)
					{
						
				  System.out.println("creditGuaranteed=="+creditGuaranteed);
					
					error = new ActionError("MudraKishorError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					
					}
				}

			if (mudraTypeVal.equals("TARUN") ) {
				
				/*if (osAmt > 1000000D) 
				{
					error = new ActionError("MudraTarunError");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
				*/
				
				if(creditGuaranteed>200000D)
				{
			...
			{
				error = new ActionError("MudraTypeError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
	...
	public static boolean MoratoriumEGS(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========MoratoriumEGS================");
		ActionError error = null;
		Integer repaymentMoratorium = (Integer) dynaForm.get("repaymentMoratorium");
		Integer tenureChk = (Integer) dynaForm.get("tenure");
		Integer noOfInstallment = (Integer) dynaForm.get("noOfInstallment");
		
		
		System.out.println("repaymentMoratorium ==" + repaymentMoratorium);
		System.out.println("tenureChk ==" + tenureChk);
		//System.out.println("creditGuaranteed ==" + creditGuaranteed);
		//String amountValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		//String amountProperty = field.getProperty();
		//Double amountVal = new Double(amountValue);
		 ...
		 * 
		 */
		 if(repaymentMoratorium > tenureChk)
			{
				error = new ActionError("moratoriumTenureChk");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
		
		
		if(repaymentMoratorium==null)
		{
			error = new ActionError("moratoriumRange");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		 else
		 {
			 if(repaymentMoratorium >84 || repaymentMoratorium<1)
			 {
				 error = new ActionError("moratoriumRange");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 }
		...
		if(tenureChk==null)
		{
			error = new ActionError("tenureRange");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		 else
		 {
			 if(tenureChk >120 ||tenureChk<1)
			 {
				 error = new ActionError("tenureRange");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 }
			 else if( tenureChk!=repaymentMoratorium+noOfInstallment){
				
				 error = new ActionError("tenureChk");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 }
		 }
	...
	public static boolean DPDStatusEGS(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========DPDStatusEGS================");
		ActionError error = null;
		Integer DPDStatus = (Integer) dynaForm.get("DPDStatus");
		
		System.out.println("DPDStatus ==" + DPDStatus);
		
		  if(DPDStatus==null)
		{
			error = new ActionError("DPDNull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		 else
		 {
			 if(DPDStatus>60)
			 {
				 error = new ActionError("DPDLimit");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 }
		 }
	...
	public static boolean recProcessData(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		
		System.out.println("===========recProcessData 121212================");
		return errors.isEmpty();
		
	}
	
	public static boolean validatehoReportEligBorrower(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validatehoReportEligBorrower================");
		HttpSession session = request.getSession(false);
		ActionError error = null;
		double eligibleBorrower = (Double) dynaForm.get("hoReportEligBorrower");
		//String memberName = (String) dynaForm.get("selectMember");
		
		double hoReportTotalOsAmt= (Double) dynaForm.get("hoReportTotalOs");
		double hoReport20EligOs= (Double) dynaForm.get("hoReport20EligOs");
		double hoReportNoBorrowerOffer= (Double) dynaForm.get("hoReportNoBorrowerOffer");
		double hoReportNoBorrowerOpt= (Double) dynaForm.get("hoReportNoBorrowerOpt");
		double hoReportSanctionNo= (Double) dynaForm.get("hoReportSanctionNo");
		double hoReportSanction= (Double) dynaForm.get("hoReportSanctionAmt");
		double hoReportDisburseNo= (Double) dynaForm.get("hoReportDisburseNo");
		double hoReportDisburse= (Double) dynaForm.get("hoReportDisburseAmt");
		 String memberId = (String) session.getAttribute("memberId");
		
		System.out.println("eligibleBorrower ==" + eligibleBorrower);
		System.out.println("memberId ==" + memberId);
		//System.out.println("memberName ==" + memberName);
		
		int historyCount=objApplicationDAO.getHistoryCount(memberId);
		if (historyCount > 0) {
			
			error = new ActionError("historyCountError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			
		}else {
		
		
double eligibleBorrowerAmt=objApplicationDAO.getEligibleBorrowerAmt(eligibleBorrower,memberId);
double hoReportTotalOs=objApplicationDAO.gethoReportTotalOs(hoReportTotalOsAmt,memberId);
double hoReport20EligOsAmt=objApplicationDAO.gethoReport20EligOsAmt(hoReport20EligOs,memberId);
double hoReportNoBorrowerOfferAmt=objApplicationDAO.gethoReportNoBorrowerOfferAmt(hoReportNoBorrowerOffer,memberId);
double hoReportNoBorrowerOptAmt=objApplicationDAO.gethoReportNoBorrowerOptAmt(hoReportNoBorrowerOpt,memberId);
double hoReportSanctionNoAmt=objApplicationDAO.gethoReportSanctionNoAmt(hoReportSanctionNo,memberId);
double hoReportSanctionAmt=objApplicationDAO.gethoReportSanctionAmt(hoReportSanction,memberId);
double hoReportDisburseNoAmt=objApplicationDAO.gethoReportDisburseNoAmt(hoReportDisburseNo,memberId);
double hoReportDisburseAmt=objApplicationDAO.gethoReportDisburseAmt(hoReportDisburse,memberId);

		
		
		
		
		if(eligibleBorrowerAmt>eligibleBorrower )
		{
			error = new ActionError("eligibleBorrowerAmtError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		
		
		if(hoReportTotalOs>hoReportTotalOsAmt )
		{
			error = new ActionError("hoReportTotalOsError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+hoReportTotalOs);
		System.out.println("eligibleBorrower"+hoReportTotalOsAmt);
		
		if(hoReport20EligOsAmt>hoReport20EligOs )
		{
			error = new ActionError("hoReport20EligOsAmtError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("hoReport20EligOsAmt"+hoReport20EligOsAmt);
		System.out.println("hoReport20EligOs"+hoReport20EligOs);
		
		if(hoReportNoBorrowerOfferAmt>hoReportNoBorrowerOffer )
		{
			error = new ActionError("hoReportNoBorrowerOfferError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		...
		if(hoReportNoBorrowerOptAmt>hoReportNoBorrowerOpt )
		{
			error = new ActionError("hoReportNoBorrowerOptError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		...
		if(hoReportSanctionNoAmt>hoReportSanctionNo )
		{
			error = new ActionError("hoReportSanctionNoError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		...
		if(hoReportSanctionAmt>hoReportSanction )
		{
			error = new ActionError("hoReportSanctionAmtError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		...
		if(hoReportDisburseNoAmt>hoReportDisburseNo )
		{
			error = new ActionError("hoReportDisburseNoError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
		...
		if(hoReportDisburseAmt>hoReportDisburse )
		{
			error = new ActionError("hoReportDisburseAmtError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		System.out.println("eligibleBorrowerAmt"+eligibleBorrowerAmt);
		System.out.println("eligibleBorrower"+eligibleBorrower);
	...
	public static boolean  CollateralEGS(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========CollateralEGS================");
		ActionError error = null;
		Double totalMIcollatSecAmt = (Double) dynaForm.get("totalMIcollatSecAmt");
		Double amtDisbursed = (Double) dynaForm.get("amtDisbursed");
		
		System.out.println("totalMIcollatSecAmt ==" + totalMIcollatSecAmt);
		System.out.println("amtDisbursed ==" + amtDisbursed);
		//String amountValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		//String amountProperty = field.getProperty();
		//Double amountVal = new Double(amountValue);
		//double amtValue = 0.0;
		 ...
		 * ActionError("creditGuaranteedNull");
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } else
		 */ if(totalMIcollatSecAmt==null ||totalMIcollatSecAmt.equals(""))
		{
			error = new ActionError("totalMIcollatSecAmtError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		 
		 if(amtDisbursed==null || amtDisbursed.equals(""))
			{
				error = new ActionError("amtDisbursedRequired");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
	...
	public static boolean validateNOC(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateNOC================");
		ActionError error = null;
		HttpSession session = request.getSession(false);
		
		Double osAmt = (Double) dynaForm.get("pplOS");
		
	    String mSEFlag=(String)dynaForm.get("mSE");
	    
		
		if(osAmt==null||osAmt==0.0D)
		{
			error = new ActionError("outstandingsMLINull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
	
			/*		if((mSEFlag==null||mSEFlag==""))
					{
						System.out.println("Out noo if  ==" + osAmt);
						//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
						error = new ActionError("osNOCMsg");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
					else
					{
					char c=mSEFlag.charAt(0);
					System.out.println("c Flag ==" + c);
					 if(c=='N' ) {
					
					System.out.println("Out 2nd if  ==" + osAmt);
				//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
				error = new ActionError("mSEError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
					}*/
				////}
	...
	public static boolean validateNpaDate(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateNpaDate================");
		ActionError error = null;
		HttpSession session = request.getSession(false);
		
	    Date npaDate=(Date)dynaForm.get("npaDate");
	    
	    String npaReason=(String)dynaForm.get("npaReason");
	    String otherAccStatus=(String)dynaForm.get("otherAccStatus");
	    String wcAccStatus=(String)dynaForm.get("wcAccStatus");
	    String accStatus=(String)dynaForm.get("accStatus");
	    
	    System.out.println("npaDate  ==" + npaDate);
	    System.out.println("npaDate  =="+npaDate.toString().length());
	    System.out.println("npaReason  ==" + npaReason);
	    System.out.println("otherAccStatus ==" + otherAccStatus);
	    System.out.println("wcAccStatus ==" + wcAccStatus);
	    System.out.println("accStatus  ==" + accStatus);
	    
	  if(accStatus.equals("NPA"))
	  {
				if( npaDate.toString().length()==0)	
				{
			//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
				error = new ActionError("npaDateError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
				if(npaReason.equals(null)|| npaReason.equals(""))
				{
					error = new ActionError("npaReasonError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
	...
	public static boolean validateMudraNOC(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateMudraNOC================");
		ActionError error = null;
		HttpSession session = request.getSession(false);
		Double creditGuaranteed = (Double) dynaForm.get("creditGuaranteed");
		Double osAmt = (Double) dynaForm.get("pplOS");
		Double osMLI = (Double) dynaForm.get("osMLI");
	    String nocFlag=(String)dynaForm.get("promDirDefaltFlg");
	    String mudraITPANChkVal=(String)dynaForm.get("mudraITPANChk");
	    String firmITPan=(String)dynaForm.get("ssiITPan");
	    String adharNo=(String)dynaForm.get("adhar");
	    String cpITPAN=(String)dynaForm.get("cpITPAN");
	    int DPDStatus=(Integer)dynaForm.get("DPDStatus");
	    String memberId = (String) session.getAttribute("memberId");
		...
		System.out.println("creditGuaranteed ==" + creditGuaranteed);
		System.out.println("osMLI ==" + osMLI);
		System.out.println("nocFlag ==" + nocFlag);
		//String amountValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		//String amountProperty = field.getProperty();
		//Double amountVal = new Double(amountValue);
		Double osMLIValue = 0.0D;
		Double osAmtVal=0.0D;
		Double creditGuaranteedVal=0.0D;
		
		//double totalAppbureauAmt=objApplicationDAO.getPplosItpanAmount(firmITPan,cpITPAN,memberId);
		
		//int getDPDValue=objApplicationDAO.getDPDValue(firmITPan,cpITPAN,memberId);
		
		if((firmITPan==null || firmITPan=="") && (adharNo==null || adharNo==""))
		{
					if((mudraITPANChkVal==null||mudraITPANChkVal==""))
					{
						System.out.println("Out noo if  ==" + osAmtVal);
						//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
						error = new ActionError("mudraITPANChkNull");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
					else
					{
					char mudraFlag=mudraITPANChkVal.charAt(0);
					System.out.println("c mudraFlag ==" + mudraFlag);
					 if(mudraFlag=='N' ) {
		...
		if (creditGuaranteed > 0.0D) 
		{
	
			osMLIValue=(osMLI*(20D/100D)); 
			
			osAmtVal=(osAmt*(20D/100D));
			
			double remainingTotalBureauAmount=osAmtVal;
			
			double remainingTotalAmount=osAmtVal;
			double remainingMLIAmount=osMLIValue;
			
			//double logic=creditGuaranteed+appApprovedAmt;
			System.out.println("Out osAmtVal amt ==" + osAmtVal);
			System.out.println("osMLIValue amt ==" + osMLIValue);
			System.out.println("creditGuaranteed ==" + creditGuaranteed);
			System.out.println("remainingTotalAmount ==" + remainingTotalAmount);
			System.out.println("remainingMLIAmount ==" + remainingMLIAmount);
			
			if(creditGuaranteed>remainingTotalBureauAmount)
			{
				System.out.println("1 if====");
					
					error = new ActionError("osGreaterThanMudraLogic");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				
			}
			else if(creditGuaranteed>osMLIValue && creditGuaranteed>remainingMLIAmount )
			{
				
				System.out.println("Out 1st if  ==" + osAmtVal);
				
			
					if((nocFlag==null||nocFlag==""))
					{
						System.out.println("Out noo if  ==" + osAmtVal);
						//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
						error = new ActionError("osNOCMsg");
					...
					{
					char c=nocFlag.charAt(0);
					System.out.println("c Flag ==" + c);
					 if(c=='N' ) {
					
					System.out.println("Out 2nd if  ==" + osAmtVal);
				//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
				error = new ActionError("osNOCMsg");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
	...
	public static boolean validateTypeTC(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateTypeLoan================");
		ActionError error = null;
		double typeLoanTC = (Double) dynaForm.get("TCTYPE");
		double typeLoanWC = (Double) dynaForm.get("WCTYPE");
		
		System.out.println("typeLoanTC ==" + typeLoanTC);
		System.out.println("typeLoanWC ==" + typeLoanWC);
		//String amountValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		//String amountProperty = field.getProperty();
		//Double amountVal = new Double(amountValue);
		double amtValue =typeLoanTC+typeLoanWC;
		...
		if (amtValue>100D) 
		{
			...
			System.out.println("typeLoanTC1 ==" + typeLoanTC);
			System.out.println("typeLoanWC1 ==" + typeLoanWC);
			System.out.println("amtValue amt ==" + amtValue);
		
			
				//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
				error = new ActionError("TCLoanTypeError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			
		}
		else if(amtValue!=100D)
		{
			//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched2"));
			error = new ActionError("TCLoanTypeErrornull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	public static boolean validateTypeLoan(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========validateTypeLoan================");
		ActionError error = null;
		double typeLoanTC = (Double) dynaForm.get("TypeLoanTC");
		double typeLoanWC = (Double) dynaForm.get("TypeLoanWC");
		...
		if (amtValue>100D) 
		{
			...
			System.out.println("amtValue amt ==" + amtValue);
				...
				//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched1"));
				error = new ActionError("LoanTypeError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		...
		{
			//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("egsValueNotMatched2"));
			error = new ActionError("LoanTypeErrornull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	public static boolean turnOverValidate(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========turnOverValidate================");
		ActionError error = null;
		double turnOverVal = (Double) dynaForm.get("projectedSalesTurnover");
		
		System.out.println("projectedSalesTurnover"+turnOverVal);
		
		 if(turnOverVal >0.0D && turnOverVal>1000000000D)
		  {
			 
				 
				 error = new ActionError("turnovermaxrequired");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		  }
	...
	public static boolean checkEmailFormatValid(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========checkEmailFormatValid================");
		ActionError error = null;
		...
		{
			error = new ActionError("emailIdNull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		}
		...
		else
		  {
			...
			{
				System.out.println( "error else==");
				error = new ActionError("emailIdValidate");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
		  }
	...
	public static boolean checknoEmailFormatValid(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========checknoEmailFormatValid================");
		ActionError error = null;
		String emailId = (String) dynaForm.get("noEmailId");
	...
	public static boolean gstNoValidate(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========gstNoValidate================");
		ActionError error = null;
		String activityConfirm = (String) dynaForm.get("activityConfirm");
		String gstNo = (String) dynaForm.get("BorrowergstNo");
		System.out.println("activityConfirm=="+activityConfirm);
		char c=activityConfirm.charAt(0);
		System.out.println("gstNo=="+gstNo);
		System.out.println("c==="+c);
		
		if(c=='N' &&( gstNo==null || gstNo==""))
		{
			error = new ActionError("gstNo");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		 
			 System.out.println("gstNoIsRequired==error"+error);
		}else if(c=='o' && c!='N' )
		{
			
		}
		else if(c=='N' && ( gstNo!=null || gstNo!="")){
			...
			{
				error = new ActionError("gstNoValid");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
	...
	public static boolean brnGstNoValidate(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) throws Exception {
		DynaActionForm dynaForm = (DynaActionForm) bean;
		System.out.println("===========brnGstNoValidate================");
		ActionError error = null;
		String gstNo = (String) dynaForm.get("brnGstNo");
		if( gstNo==null || gstNo=="")
		{
			error = new ActionError("brnGstNonull");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
		...
		}else
		{
			...
			Pattern pattern = Pattern.compile("[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}[ZD]{1}[0-9A-Z]{1}");
			...
			{
				error = new ActionError("brnGstNoValid");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
	...
	public static boolean validateAfterCurrentDates(Object bean, ValidatorAction validAction, Field field,
		...
		System.out.println("validateAfterCurrentDates===");
	...
	//	String fromValue = ValidatorUtil.getValueAsString(bean, field.getProperty());
		...
		try {
			String stringDate = dateFormat.format(currentDate);
			if (!GenericValidator.isBlankOrNull(amountSanctionedDate) && DateHelper.compareDates(amountSanctionedDate, stringDate) != -1
					&& DateHelper.compareDates(amountSanctionedDate, stringDate) != 0) {
			
				
				error = new ActionError("futureDate");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			...
			ActionError actionError = new ActionError(
					(new StringBuilder()).append(amountSanctionedDate).append(" is not a valid Date").toString());
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		}
		return errors.isEmpty();
	}
	...
	public static boolean validateFromNPACurrentDatesNew(Object bean, ValidatorAction validAction, Field field,
		...
		try {
			 ...
			 * { //NpaTenDate ActionError actionError = new
		...
		try {
			...
			if (loanType.equalsIgnoreCase("tc") && !"".equals(dynaForm.get("amountSanctionedDate"))) {
				...
				if (!validatedateSanctionDate(funcBasedSanctionedDate)
						&& !validatedateSanctionDate(nonFuncBasedSanctionedDate) && interestRate > baseRate + 4D) {
					ActionError error = new ActionError("baseRateAndInterestRate", Double.valueOf(baseRate),
							Double.valueOf(interestRate));
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
...
//27/04/2020 DIKSHA
	/*
	 * public static boolean PrimarySecurityCheck(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest request) {
	 * DynaActionForm dynaForm = (DynaActionForm) bean; String flag = (String)
	 * dynaForm.get("pSecurity"); String chk = (String)
	 * dynaForm.get("exposureFbId"); if (chk.equals("N1")) { if (flag.equals("N")) {
	 * ActionError actionError = new ActionError("PlsEnterSecFalg");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); // dkr@
	 * need to remove comment } } return errors.isEmpty(); }
	 */
	...
	public static boolean SanctionedDateValidation(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
			HttpServletRequest request) throws DatabaseException {
		
		System.out.println("-====SanctionedDateValidation=========");
		DynaActionForm dynaForm = (DynaActionForm) bean;
		boolean cpItPanFlag = false;
		ActionError error = null;
		HttpSession session = request.getSession(false);
		...
		String mliId = user.getBankId() + user.getZoneId() + user.getBranchId();
		
		System.out.println("mliId:::"+mliId);
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		
		Date sanctionedDate = (Date) dynaForm.get("sanctionDate");
		System.out.println("sanctionDate==="+sanctionedDate);
		boolean result = true;
		...
		//ActionError error=null;
			...
			Date date;
			try {
				date = sdf.parse("24/06/2020");
				System.out.println("Date====="+date);
			
			if (sanctionedDate.before(date)) {
				//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("sanctionedDateError"));
				error = new ActionError("sanctionedDateError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
			
			String error1 = objApplicationDAO.getsanctionDateError(mliId,sanctionedDate);
			System.out.println("here error"+error1);
			if(error1 != null && error1.toString()!=""){
				error = new ActionError("sanctionDateRelaxation",error1);
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
			
			try {
				Date dateobj = sdf.parse(sdf.format(new Date()));
				
				//Date dateobj = new Date();
				System.out.println("dateobj==="+dateobj);
				if (sanctionedDate.after(dateobj)) {
					System.out.println("dateobj==="+dateobj);
					//errors.add("org.apache.struts.action.GLOBAL_ERROR", new ActionError("sanctionedDateError"));
					error = new ActionError("futureDate");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				...
				System.out.println(sanctionedDate + "..................sanctionedDate");
	...
	public static boolean checkCreditAmtAndSanctionDate(Object bean, ValidatorAction validAction, Field field,
		...
		try {
			 ...
			 * 
			 * System.out.println("none"+none); System.out.println("cgbid"+cgbid);
			 */

			/*
			 * String strPreviouslyCovered=""; String strNone=""; String strCgbid="";
			 * 
			 * if(previouslyCovered!=null && previouslyCovered.equalsIgnoreCase("Y")) {
			 * session.setAttribute("previouslyCovered", previouslyCovered);
			 * session.setAttribute("none", none); session.setAttribute("cgbid", cgbid);
			 ...
			 * 
			 * System.out.println("11111none"+none); System.out.println("11111cgbid"+cgbid);
			 * 
			 ...
			 * limitFundBasedSanctionedDate);
			 * dateAndAmountDtl.put("limitNonFundBasedSanctionedDate",
			 * limitNonFundBasedCommission); dateAndAmountDtl.put("creditGuaranteed",
			 * creditGuaranteed); dateAndAmountDtl.put("creditFundBased", creditFundBased);
			 * dateAndAmountDtl.put("creditNonFundBased", creditNonFundBased);
			 * 
			 * HashMap basedOnCondition = new HashMap();
			 * 
			 * basedOnCondition.put("previouslyCovered", previouslyCovered);
			 * basedOnCondition.put("none", none); basedOnCondition.put("cgbid", cgbid);
			...
			if (flag = true && verifyBankTypeAndApproveLoanAmount(loanType, creditGuaranteed, creditFundBased,
					creditNonFundBased, bankId, basedOnCondition, classificationofMLI) == false) {
				ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
			dateAndAmountDtl.clear();
	 ...
	 * validAction, Field field, ActionErrors errors, HttpServletRequest request)
	 * throws Exception { Log.log(4, "validation", "validDateFormat",
	 * "validateUdyogAdharNo()"); DynaActionForm dynaForm = (DynaActionForm) bean;
	 * String udhyogAdharNo = (String) dynaForm.get(field.getProperty()); if
	 * (!udhyogAdharNo.trim().equals("")) { Pattern pattern = Pattern
	 ...
	 * 
	 * } else { ActionError actionError = new ActionError("udyogAdharNoInvalid");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); //
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", new //
	 ...
	 * System.out.println("udhyogAdharNo=="+udhyogAdharNo); boolean resultFlag=true;
	 * 
	 * 
	 * 
	 ...
	 * validAction, Field field, ActionErrors errors, HttpServletRequest request) {
	 * DynaActionForm dynaForm = (DynaActionForm) bean; String stateCode = (String)
	 * dynaForm.get("stateCode"); if (stateCode == null && stateCode.equals("")) {
	 * ActionError actionError = new ActionError("stateCodeRequired");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } return
	 * errors.isEmpty(); }
	 */
	 ...
	 * 
	 * Log.log(4, "validation", "validDateFormat", "validDateFormat().......dob");
	 * boolean dateVal = false; try { Date date = new
	 * SimpleDateFormat("dd/MM/yyyy").parse(inDate); dateVal = new
	 * Date().after(date); } catch (ParseException pe) { Log.log(2, "validation",
	 * "validDateFormat", pe.getMessage()); dateVal = false; } return dateVal;
	 * 
	 * }
	 */
	...
	public static boolean validateExistGreenUnit(Object bean, ValidatorAction validAction, Field field,
			...
			if ((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC"))
				...
				if (dynaForm.get("amountSanctionedDate").toString().length() != 0) {
					...
					if (amountSanctionedDateVal.compareTo(enterdDateVal) >= 0) {
						datFlag4UI1 = true;
						System.out.println(
								(new StringBuilder("datFlag4UI1 ::::::::::::::::::")).append(datFlag4UI1).toString());
					} else {
						datFlag4UI1 = false;
			...
			if ((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC"))
				...
				if (dynaForm.get("limitNonFundBasedSanctionedDate").toString().length() != 0) {
					if (limitNonFundBasedSanctionedDateVal.compareTo(enterdDateVal) >= 0) {
						datFlag4UI3 = true;
						System.out.println(
								(new StringBuilder("datFlag4UI3::::::::::::::::::")).append(datFlag4UI3).toString());
					} else {
						datFlag4UI3 = false;
						session.setAttribute("gFinancialUIflag", "DFALSEUI");
						session.setAttribute("dblockUI", "");
		...
		if (sessionLoanType.equals("TC") && amountSanctionedDateVal != null && creditGuaranteedVal != 0.0D
			...
			if (creditGuaranteedVal > 1000000D && creditGuaranteedVal <= 5000000D && datFlag4UI1) {
				System.out.println(
						"validateExistGreenUnit entered TC 2 ======== creditGuaranteed > 1000000 && creditGuaranteed <= 5000000");
			...
			if (creditGuaranteedVal > 5000000D && creditGuaranteedVal < 10000000D && datFlag4UI1) {
				...
				session.removeAttribute("gFinancialUIflag");
				System.out.println(
						"validateExistGreenUnit entered TC 3==== creditGuaranteed > 5000000 && creditGuaranteed <= 10000000");
				if (existGreenFldUnitType == "" || existGreenFldUnitType.equals("")) {
					ActionError actionError = new ActionError("existGreenFieldUnitsError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			...
			if (creditGuaranteedVal >= 10000000D && creditGuaranteedVal <= 25000000D && datFlag4UI1) {
				session.removeAttribute("dblockUI");
		...
		if (sessionLoanType.equals("WC") && (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D)
			...
			if (totalFundNonBaseGurAmtVal.doubleValue() > 1000000D
				...
				System.out.println(
						"validateExistGreenUnit entered WC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 ");
				if (opratIncome == 0.0F) {
					ActionError actionError = new ActionError("oprtIncError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			...
			if (totalFundNonBaseGurAmtVal.doubleValue() > 5000000D
				...
				System.out.println(
						"validateExistGreenUnit entered WC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <= 100000000 ");
				session.setAttribute("dblockUI", "UI_3");
				session.setAttribute("gFinancialUIflag", "DFALSEUI");
				session.removeAttribute("gFinancialUIflag");
				if (existGreenFldUnitType == "" || existGreenFldUnitType.equals("")) {
			...
			if (sessionLoanType.equals("WC") && !sessionLoanType.equals("TC")
					...
					&& creditFundBasedVal + creditNonFundBasedVal <= 25000000D && (datFlag4UI2 || datFlag4UI3)) {
		...
		if ((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && amountSanctionedDateVal != null
			...
			Double totalFundNonBaseGurAmtVal = Double
					.valueOf(creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal);
			if (totalFundNonBaseGurAmtVal.doubleValue() != 0.0D && totalFundNonBaseGurAmtVal.doubleValue() >= 100000D
			...
			if (totalFundNonBaseGurAmtVal.doubleValue() > 1000000D
				...
				System.out.println(
						"validateExistGreenUnit entered CC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 ");
				if (opratIncome == 0.0F) {
					ActionError actionError = new ActionError("oprtIncError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			...
			if (totalFundNonBaseGurAmtVal.doubleValue() > 5000000D
				...
				System.out.println(
						"validateExistGreenUnit entered CC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal < 10000000");
				if (opratIncome == 0.0F) {
					ActionError actionError = new ActionError("oprtIncError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			...
			if ((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && !sessionLoanType.equals("TC")
					...
					&& (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D)
					&& creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal >= 10000000D
					&& creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal <= 20000000D
	...
	/*
	 * public static boolean validateExistGreenUnit(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest request) {
	 * 
	 * Log.log(4, "Validator.java", "validateExistGreenUnit()",
	 * "Insert in validateExistGreenUnit()");
	 * System.out.println("validateExistGreenUnit entered====DR=="); DynaActionForm
	 * dynaForm = (DynaActionForm) bean; HttpSession session =
	 * request.getSession(false); Date seltdate1=null,seltdate2=null,seltdate3=null;
	 * 
	 * String enableUIFlag = ""; String myDate = "01/12/2018";
	 * 
	 * java.util.Date amountSanctionedDateVal = null; java.util.Date
	 * limitFundbasedSanctionedDateVal = null; java.util.Date
	 * limitNonFundBasedSanctionedDateVal= null; Date enterdDateVal = null; double
	 * creditGuaranteedVal=0.0d; double creditFundBasedVal =0.0d; double
	 * creditNonFundBasedVal = 0.0d; boolean datFlag4UI1 = false, datFlag4UI2=false,
	 * datFlag4UI3=false; float opratIncome=0.0f; float profAftTax=0.0f; float
	 * networth=0.0f; float debitEqtRatioUnt=0.0f; float
	 * debitSrvCoverageRatioTl=0.0f; float currentRatioWc=0.0f; float
	 * debitEqtRatio=0.0f; float debitSrvCoverageRatio=0.0f; float
	 * currentRatios=0.0f; int creditBureauChiefPromScor=0; float totalAssets=0.0f;
	 * String existGreenFldUnitType = ""; // added by DKR ExistGreen Validation
	 * start
	 * 
	 * String flag = ""; int credBureKeyPromScor=0; int credBurePromScor2=0; int
	 * credBurePromScor3=0; int credBurePromScor4=0; int credBurePromScor5=0; String
	 * credBureName1=""; String credBureName2=""; String credBureName3=""; String
	 * credBureName4=""; String credBureName5=""; int cibilFirmMsmeRank=0; int
	 * expCommerScor=0; float promBorrNetWorth=0.0f; int promContribution=0; String
	 * promGAssoNPA1YrFlg=""; int promBussExpYr=0; float salesRevenue=0.0f; float
	 * taxPBIT=0.0f; float interestPayment=0.0f; float taxCurrentProvisionAmt=0.0f;
	 * float totCurrentAssets=0.0f; float totCurrentLiability=0.0f; float
	 * totTermLiability=0.0f; float exuityCapital=0.0f; float
	 * preferenceCapital=0.0f; float reservesSurplus=0.0f; float
	 * repaymentDueNyrAmt=0.0f;
	 * 
	 * 
	 * String sessionLoanType =
	 * (String)session.getAttribute("APPLICATION_LOAN_TYPE");
	 * if((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") ||
	 * sessionLoanType.equals("CC")) && null!=dynaForm.get("creditGuaranteed")){
	 * creditGuaranteedVal = (Double) dynaForm.get("creditGuaranteed");
	 * System.out.println(
	 * "creditGuaranteedVal.....................validator......................................"
	 * +creditGuaranteedVal); } if((sessionLoanType.equals("WC") ||
	 * sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) &&
	 * (null!=dynaForm.get("creditFundBased") ||
	 * null!=dynaForm.get("creditNonFundBased"))) { creditFundBasedVal = (Double)
	 * dynaForm.get("creditFundBased"); creditNonFundBasedVal = (Double)
	 * dynaForm.get("creditNonFundBased"); System.out.println(
	 * "creditFundBasedVal.....................validator...................creditNonFundBasedVal..................."
	 * +creditFundBasedVal+"<<<<...>>>>"+creditNonFundBasedVal); } try {
	 * SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy"); enterdDateVal =
	 * df.parse(myDate); if((sessionLoanType.equals("TC") ||
	 * sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && null!=
	 * dynaForm.get("amountSanctionedDate") ) {
	 * 
	 * //System.out.println("dynaForm.get(\"amountSanctionedDate\") :"+dynaForm.get(
	 * "amountSanctionedDate"));
	 * //System.out.println("dynaForm.get(\"amountSanctionedDate\") length:"
	 * +dynaForm.get("amountSanctionedDate").toString().length());
	 * if(dynaForm.get("amountSanctionedDate").toString().length()!=0) {
	 * 
	 * amountSanctionedDateVal = (java.util.Date)
	 * dynaForm.get("amountSanctionedDate");
	 * if(amountSanctionedDateVal.compareTo(enterdDateVal)>=0) { datFlag4UI1 = true;
	 * System.out.println("datFlag4UI1 ::::::::::::::::::"+datFlag4UI1); }else {
	 * datFlag4UI1 = false; session.setAttribute("gFinancialUIflag","DFALSEUI");
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.removeAttribute("dblockUI"); }
	 * 
	 * }else { datFlag4UI1 = false;
	 * session.setAttribute("gFinancialUIflag","DFALSEUI");
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.removeAttribute("dblockUI"); }
	 * 
	 * 
	 * } if((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") ||
	 * sessionLoanType.equals("CC")) &&
	 * (null!=dynaForm.get("limitFundBasedSanctionedDate") ||
	 * null!=dynaForm.get("limitNonFundBasedSanctionedDate"))) {
	 * limitFundbasedSanctionedDateVal = (java.util.Date)
	 * dynaForm.get("limitFundBasedSanctionedDate");
	 * limitNonFundBasedSanctionedDateVal =
	 * (java.util.Date)dynaForm.get("limitNonFundBasedSanctionedDate");
	 * if(dynaForm.get("limitFundBasedSanctionedDate").toString().length()!=0) {
	 * if(limitFundbasedSanctionedDateVal.compareTo(enterdDateVal)>=0) { datFlag4UI2
	 * = true; System.out.println("datFlag4UI2::::::::::::::::::"+datFlag4UI2);
	 * }else { datFlag4UI2 = false;
	 * session.setAttribute("gFinancialUIflag","DFALSEUI");
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.removeAttribute("dblockUI"); } }else { datFlag4UI2 = false;
	 * session.setAttribute("gFinancialUIflag","DFALSEUI");
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.removeAttribute("dblockUI"); }
	 ...
	 * if(limitNonFundBasedSanctionedDateVal.compareTo(enterdDateVal)>=0) {
	 * datFlag4UI3 = true;
	 * System.out.println("datFlag4UI3::::::::::::::::::"+datFlag4UI3); }else {
	 * datFlag4UI3 = false; session.setAttribute("gFinancialUIflag","DFALSEUI");
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 ...
	 * session.setAttribute("dblockUI","");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.removeAttribute("dblockUI"); } } }catch (ParseException
	 * parseException) { System.out.println("Date parsing problem 12864");
	 * Log.log(2, "Validator.java", "validateExistGreenUnit()",
	 * "Error ParseException D"); ActionError actionError = new
	 * ActionError("errors.date");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * if(null!= dynaForm.get("existGreenFldUnitType")) { existGreenFldUnitType =
	 * (String) dynaForm.get("existGreenFldUnitType"); }
	 * if(null!=dynaForm.get("opratIncome")) { opratIncome = (Float)
	 * dynaForm.get("opratIncome"); } if(null!=dynaForm.get("profAftTax")) {
	 * profAftTax = (Float) dynaForm.get("profAftTax"); }
	 * if(null!=dynaForm.get("networth")) { networth = (Float)
	 * dynaForm.get("networth");
	 * System.out.println("networth >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +networth); } if(null!=dynaForm.get("debitEqtRatioUnt")) { debitEqtRatioUnt =
	 * (Float) dynaForm.get("debitEqtRatioUnt"); System.out.
	 * println("debitEqtRatioUnt >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +debitEqtRatioUnt); } if(null!=dynaForm.get("debitSrvCoverageRatioTl")) {
	 * debitSrvCoverageRatioTl = (Float) dynaForm.get("debitSrvCoverageRatioTl");
	 * System.out.
	 * println("debitSrvCoverageRatioTl >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +debitSrvCoverageRatioTl); } if(null!=dynaForm.get("currentRatioWc")) {
	 * currentRatioWc = (Float) dynaForm.get("currentRatioWc"); System.out.
	 * println("currentRatioWc >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +currentRatioWc); } if(null!=dynaForm.get("debitEqtRatio")) { debitEqtRatio =
	 * (Float) dynaForm.get("debitEqtRatio"); System.out.
	 * println("debitEqtRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +debitEqtRatio); } if(null!=dynaForm.get("debitSrvCoverageRatio")) {
	 * debitSrvCoverageRatio = (Float) dynaForm.get("debitSrvCoverageRatio");
	 * System.out.
	 * println("debitSrvCoverageRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "
	 * +debitSrvCoverageRatio); } if(null!=dynaForm.get("currentRatios")) {
	 * currentRatios = (Float) dynaForm.get("currentRatios"); }
	 * if(null!=dynaForm.get("creditBureauChiefPromScor")) {
	 * creditBureauChiefPromScor = (Integer)
	 * dynaForm.get("creditBureauChiefPromScor"); }
	 * if(null!=dynaForm.get("totalAssets")) { totalAssets = (Float)
	 * dynaForm.get("totalAssets"); }
	 * 
	 * if(null!= dynaForm.get("promDirDefaltFlg")) { flag = (String)
	 * dynaForm.get("promDirDefaltFlg"); } if(null!=
	 * dynaForm.get("credBureKeyPromScor")) {
	 * credBureKeyPromScor=(Integer)dynaForm.get("credBureKeyPromScor"); } if(null!=
	 * dynaForm.get("credBurePromScor2")) {
	 * credBurePromScor2=(Integer)dynaForm.get("credBurePromScor2"); } if(null!=
	 * dynaForm.get("credBurePromScor3")) {
	 * credBurePromScor3=(Integer)dynaForm.get("credBurePromScor3"); } if(null!=
	 * dynaForm.get("credBurePromScor4")) {
	 * credBurePromScor4=(Integer)dynaForm.get("credBurePromScor4"); } if(null!=
	 * dynaForm.get("credBurePromScor5")) {
	 * credBurePromScor5=(Integer)dynaForm.get("credBurePromScor5"); } if(null!=
	 * dynaForm.get("credBureName1")) {
	 * credBureName1=(String)dynaForm.get("credBureName1"); } if(null!=
	 * dynaForm.get("credBureName2")) {
	 * credBureName2=(String)dynaForm.get("credBureName2"); } if(null!=
	 * dynaForm.get("credBureName3")) {
	 * credBureName3=(String)dynaForm.get("credBureName3"); } if(null!=
	 * dynaForm.get("credBureName4")) {
	 * credBureName4=(String)dynaForm.get("credBureName4"); } if(null!=
	 * dynaForm.get("credBureName5")) {
	 * credBureName5=(String)dynaForm.get("credBureName5"); } if(null!=
	 * dynaForm.get("cibilFirmMsmeRank")) {
	 * cibilFirmMsmeRank=(Integer)dynaForm.get("cibilFirmMsmeRank"); } if(null!=
	 * dynaForm.get("expCommerScor")) {
	 * expCommerScor=(Integer)dynaForm.get("expCommerScor"); } if(null!=
	 * dynaForm.get("promBorrNetWorth")) {
	 * promBorrNetWorth=(Float)dynaForm.get("promBorrNetWorth"); } if(null!=
	 * dynaForm.get("promContribution")) {
	 * promContribution=(Integer)dynaForm.get("promContribution"); } if(null!=
	 * dynaForm.get("promGAssoNPA1YrFlg")) {
	 * promGAssoNPA1YrFlg=(String)dynaForm.get("promGAssoNPA1YrFlg"); } if(null!=
	 * dynaForm.get("promBussExpYr")) {
	 * promBussExpYr=(Integer)dynaForm.get("promBussExpYr"); } if(null!=
	 * dynaForm.get("salesRevenue")) {
	 * salesRevenue=(Float)dynaForm.get("salesRevenue"); } if(null!=
	 * dynaForm.get("taxPBIT")) { taxPBIT=(Float)dynaForm.get("taxPBIT"); }
	 * if(null!= dynaForm.get("interestPayment")) {
	 * interestPayment=(Float)dynaForm.get("interestPayment"); } if(null!=
	 * dynaForm.get("taxCurrentProvisionAmt")) {
	 * taxCurrentProvisionAmt=(Float)dynaForm.get("taxCurrentProvisionAmt"); }
	 * if(null!= dynaForm.get("totCurrentAssets")) {
	 * totCurrentAssets=(Float)dynaForm.get("totCurrentAssets"); } if(null!=
	 * dynaForm.get("totCurrentLiability")) {
	 * totCurrentLiability=(Float)dynaForm.get("totCurrentLiability"); } if(null!=
	 * dynaForm.get("totTermLiability")) {
	 * totTermLiability=(Float)dynaForm.get("totTermLiability"); } if(null!=
	 * dynaForm.get("exuityCapital")) {
	 * exuityCapital=(Float)dynaForm.get("exuityCapital"); } if(null!=
	 * dynaForm.get("preferenceCapital")) {
	 * preferenceCapital=(Float)dynaForm.get("preferenceCapital"); } if(null!=
	 * dynaForm.get("reservesSurplus")) {
	 * reservesSurplus=(Float)dynaForm.get("reservesSurplus"); } if(null!=
	 * dynaForm.get("repaymentDueNyrAmt")) {
	 * repaymentDueNyrAmt=(Float)dynaForm.get("repaymentDueNyrAmt"); }
	 * 
	 * 
	 * //***************
	 * 
	 * if(sessionLoanType.equals("TC") && null!=amountSanctionedDateVal &&
	 * creditGuaranteedVal!= 0.0d && datFlag4UI1==true){
	 * 
	 * Log.log(4, "Validator.java", "validateExistGreenUnit()", "TC");
	 * 
	 * if(creditGuaranteedVal >= 100000 && creditGuaranteedVal <= 1000000 &&
	 * datFlag4UI1==true){ // session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("dblockUI","UI_1");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag");
	 * 
	 * System.out.
	 * println("validateExistGreenUnit entered TC 1==============creditGuaranteed >= 100000 && creditGuaranteed <= 1000000"
	 * );
	 * 
	 * 
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(profAftTax==0.0f) { ActionError actionError = new ActionError("patError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(networth==0.0f) { ActionError actionError = new
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * } if(creditGuaranteedVal > 1000000 && creditGuaranteedVal <=5000000 &&
	 * datFlag4UI1==true){ System.out.
	 * println("validateExistGreenUnit entered TC 2 ======== creditGuaranteed > 1000000 && creditGuaranteed <= 5000000"
	 * );
	 * 
	 ...
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitEqtRatioUnt==0.0f){ ActionError actionError = new
	 * ActionError("dvtEqtRatioUntError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitSrvCoverageRatioTl==0.0f) { ActionError actionError = new
	 * ActionError("dvtSrvCoverageRatioTlError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(currentRatioWc==0) { ActionError actionError = new
	 * ActionError("crtRatioWcError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 ...
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitEqtRatioUnt==0){ ActionError actionError = new
	 * ActionError("dvtEqtRatioUntError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitSrvCoverageRatioTl==0) { ActionError actionError = new
	 * ActionError("dvtSrvCoverageRatioTlError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(currentRatioWc==0) { ActionError actionError = new
	 * ActionError("crtRatioWcError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * } if(creditGuaranteedVal > 5000000 && creditGuaranteedVal < 10000000 &&
	 * datFlag4UI1==true){
	 * 
	 * // session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 ...
	 * 
	 * System.out.
	 * println("validateExistGreenUnit entered TC 3==== creditGuaranteed > 5000000 && creditGuaranteed <= 10000000"
	 * ); if(existGreenFldUnitType=="" || existGreenFldUnitType.equals("")){
	 * ActionError actionError = new ActionError("existGreenFieldUnitsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 ...
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitEqtRatio==0.0f){ ActionError actionError = new
	 * ActionError("dvtEqtRatioError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * 
	 * if(currentRatios==0.0f){ ActionError actionError = new
	 * ActionError("crtRatioError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * 
	 ...
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(creditBureauChiefPromScor==0) { ActionError actionError = new
	 * ActionError("crdBureauChiefPromScorError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(totalAssets==0.0f) { ActionError actionError = new
	 * ActionError("totAssetsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 ...
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(debitEqtRatio==0){ ActionError actionError = new
	 * ActionError("dvtEqtRatioError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * 
	 * if(currentRatios==0){ ActionError actionError = new
	 * ActionError("crtRatioError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * 
	 * if(debitSrvCoverageRatio==0) { ActionError actionError = new
	 * ActionError("dvtSrvCoverageRatioError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(creditBureauChiefPromScor==0) { ActionError actionError = new
	 * ActionError("crdBureauChiefPromScorError");
	 ...
	 * ActionError("totAssetsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } } if
	 * (creditGuaranteedVal >= 10000000 && creditGuaranteedVal <= 20000000 &&
	 * datFlag4UI1==true){ session.setAttribute("dblockUI","RFALSEUI");
	 * session.removeAttribute("dblockUI");
	 * 
	 * validatePromDirDefaltDetails(session, errors,flag,
	 * credBureKeyPromScor,credBurePromScor2,credBurePromScor3,credBurePromScor4,
	 * credBurePromScor5,credBureName1,credBureName2,credBureName3,
	 * credBureName4,credBureName5,cibilFirmMsmeRank,expCommerScor,promBorrNetWorth,
	 * promContribution,promGAssoNPA1YrFlg,promBussExpYr,salesRevenue,taxPBIT,
	 * interestPayment,
	 * taxCurrentProvisionAmt,totCurrentAssets,totCurrentLiability,totTermLiability,
	 * exuityCapital,preferenceCapital,reservesSurplus,repaymentDueNyrAmt); }
	 * 
	 * 
	 * } if(sessionLoanType.equals("WC") && (creditFundBasedVal!=0.0d ||
	 * creditNonFundBasedVal!= 0.0d) && (null!=limitFundbasedSanctionedDateVal ||
	 * null!=limitNonFundBasedSanctionedDateVal) && (datFlag4UI2==true ||
	 * datFlag4UI3==true)){ // if(sessionLoanType.equals("WC") &&
	 * creditFundBasedVal!=0.0d && creditNonFundBasedVal!= 0.0d &&
	 * null!=limitNonFundBasedSanctionedDateVal &&
	 * null!=limitFundbasedSanctionedDateVal && (datFlag4UI2==true &&
	 * datFlag4UI3==true)){ Log.log(4, "Validator.java", "validateExistGreenUnit()",
	 * "WC"); Double totalFundNonBaseGurAmtVal = creditFundBasedVal +
	 * creditNonFundBasedVal; System.out.println("Insert into WC...............");
	 * if(totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 &&
	 * totalFundNonBaseGurAmtVal <= 1000000 && (datFlag4UI2==true ||
	 * datFlag4UI3==true)){ session.setAttribute("dblockUI","UI_1");
	 * //session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag");
	 * 
	 * System.out.
	 * println("validateExistGreenUnit entered WC 1==totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000"
	 ...
	 * ActionError("netwrthError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } }
	 * if(totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <=
	 * 5000000 && (datFlag4UI2==true || datFlag4UI3==true)){
	 * session.setAttribute("dblockUI","UI_2"); //
	 * session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag"); if(existGreenFldUnitType=="" ||
	 * existGreenFldUnitType.equals("")){ ActionError actionError = new
	 * ActionError("existGreenFieldUnitsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * System.out.
	 * println("validateExistGreenUnit entered WC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 "
	 * ); if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(profAftTax==0.0f) { ActionError actionError = new ActionError("patError");
	 ...
	 * ActionError("dvtSrvCoverageRatioTlError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(currentRatioWc==0.0f) { ActionError actionError = new
	 * ActionError("crtRatioWcError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 ...
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * 
	 * } if(totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <
	 * 10000000 && (datFlag4UI2==true || datFlag4UI3==true)){ System.out.
	 * println("validateExistGreenUnit entered WC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <= 100000000 "
	 * ); session.setAttribute("dblockUI","UI_3"); //
	 * session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag"); if(existGreenFldUnitType=="" ||
	 ...
	 * ActionError("totAssetsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } } if((
	 * sessionLoanType.equals("WC") && (!sessionLoanType.equals("TC") &&
	 * (!sessionLoanType.equals("BO") || !sessionLoanType.equals("CC")))) &&
	 * (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d) &&
	 * (null!=limitNonFundBasedSanctionedDateVal ||
	 * null!=limitFundbasedSanctionedDateVal) && ((creditFundBasedVal +
	 * creditNonFundBasedVal) >= 10000000) &&
	 * ((creditFundBasedVal+creditNonFundBasedVal) <= 20000000) &&
	 * (datFlag4UI2==true || datFlag4UI3==true)){
	 * session.setAttribute("dblockUI","RFALSEUI");
	 * session.removeAttribute("dblockUI");
	 * 
	 * validatePromDirDefaltDetails(session, errors,flag,
	 ...
	 * null!=amountSanctionedDateVal && (null!=limitNonFundBasedSanctionedDateVal ||
	 * null!=limitFundbasedSanctionedDateVal) && creditGuaranteedVal!= 0.0d &&
	 * (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d) &&
	 * datFlag4UI1==true && (datFlag4UI2==true || datFlag4UI3==true)){ Log.log(4,
	 * "Validator.java", "validateExistGreenUnit()", "BOTH D");
	 * System.out.println("validateExistGreenUnit entered CC ====  ");
	 * 
	 * Double totalFundNonBaseGurAmtVal = creditGuaranteedVal + creditFundBasedVal +
	 * creditNonFundBasedVal; if(totalFundNonBaseGurAmtVal !=0.0 &&
	 * totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000
	 * && datFlag4UI1==true && (datFlag4UI2==true || datFlag4UI3==true)){
	 * 
	 * session.setAttribute("dblockUI","UI_1");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag");
	 ...
	 * 
	 * System.out.
	 * println("validateExistGreenUnit entered CC 1==totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000"
	 * ); if (existGreenFldUnitType == "" && existGreenFldUnitType == null) {
	 * ActionError actionError = new ActionError("existGreenFieldUnitsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(opratIncome==0.0f){ ActionError actionError = new
	 ...
	 * 
	 * if(totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <=
	 * 5000000 && datFlag4UI1==true && (datFlag4UI2==true || datFlag4UI3==true)){
	 * 
	 * session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.setAttribute("dblockUI","UI_2");
	 ...
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * System.out.
	 * println("validateExistGreenUnit entered CC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 "
	 * ); if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(profAftTax==0.0f) { ActionError actionError = new ActionError("patError");
	 ...
	 * 
	 * if(totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <
	 * 10000000 && datFlag4UI1==true && (datFlag4UI2==true || datFlag4UI3==true)){
	 * 
	 * session.setAttribute("gExgGreenUIFlag","RTRUEUI");
	 * session.setAttribute("gFinancialUIflag", "DFALSEUI");
	 * session.removeAttribute("gFinancialUIflag");
	 * session.setAttribute("dblockUI","UI_3"); if(existGreenFldUnitType=="" ||
	 * existGreenFldUnitType.equals("")){ ActionError actionError = new
	 * ActionError("existGreenFieldUnitsError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * System.out.
	 * println("validateExistGreenUnit entered CC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal < 10000000"
	 * ); if(opratIncome==0.0f){ ActionError actionError = new
	 * ActionError("oprtIncError");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * if(profAftTax==0.0f) { ActionError actionError = new ActionError("patError");
	 ...
	 * creditNonFundBasedVal) >= 10000000) && ((creditGuaranteedVal +
	 * creditFundBasedVal+creditNonFundBasedVal) <= 20000000) &&
	 * null!=amountSanctionedDateVal && (null!=limitNonFundBasedSanctionedDateVal ||
	 * null!=limitFundbasedSanctionedDateVal) && datFlag4UI1==true &&
	 * (datFlag4UI2==true || datFlag4UI3==true)){
	 * session.setAttribute("dblockUI"," "); session.removeAttribute("dblockUI");
	 * validatePromDirDefaltDetails(session, errors,flag,
	 * credBureKeyPromScor,credBurePromScor2,credBurePromScor3,credBurePromScor4,
	 * credBurePromScor5,credBureName1,credBureName2,credBureName3,
	 * credBureName4,credBureName5,cibilFirmMsmeRank,expCommerScor,promBorrNetWorth,
	 ...
	 * exuityCapital,preferenceCapital,reservesSurplus,repaymentDueNyrAmt); } }
	 * 
	 * System.out.println("Call from validator 1DKR"); Log.log(4, "Validator.java",
	 * "validateExistGreenUnit()", "EXIT"); return errors.isEmpty(); }
	 */
	// added by DKR
	public static boolean hybridSecurityCheck(Object bean, ValidatorAction validAction, Field field,
		...
		// "flag###############################immovColSecurityAmt####################movColSecurityAmt"
		// + movColSecurityAmt);
		// String flag = (String)dynaForm.get("hybridSecurity");
		if (flag.equals("Y")) {
	...
	public static boolean validateRetailIN(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		try {
			...
			if (null != dynaForm.get("totalMIcollatSecAmt")) {
				totalMIcollatSecAmtd = (Double) dynaForm.get("totalMIcollatSecAmt");
			}
			...
			if (creditGuaranteedRetail != 0.0 && creditFundBasedVal == 0.0 && creditNonFundBasedVal == 0.0) {
				...
				if (industryNatureRetail.equals("RETAIL TRADE")
					...
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				} else if (resultGuaranteedRetailVal != 0.0D && resultGuaranteedRetailVal > 25000000D) {
				...
				/*
				 * if (industryNatureRetail.equals("RETAIL TRADE") && (guaranteedRetailVald <
				 * 1000000D || guaranteedRetailVald > 10000000D)) {
				 * //System.out.println("7 Amt between 10L to 100L DKR"); ActionError
				 * actionError = new ActionError("retailTradeBoth10LTO100LCheckError");
				 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
				 * if(guaranteedRetailVald != 0.0D && guaranteedRetailVald > 20000000D) {
				 * //System.out.println("Collateral : 8 MI Amt > 2Cr "); ActionError actionError
				 * = new ActionError("Collatera200LCheckError");
				 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
				 */
				...
				if (guaranteedRetailVald != 0.0D && guaranteedRetailVald > 25000000D) {
					ActionError actionError = new ActionError("Collatera200LCheckError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			}
			 ...
			 * //System.out.println("sessionAppLoanType......test......>>>>after>>>>>>>>>>"+
			 * sessionAppLoanType); //if (null != sentDate && hybridSecurityFlg.equals("Y")
			 * && sentDate.before(new Date(collateralSenDate))) { if (null != sentDate &&
			 * sentDate.before(new Date(collateralSenDate))) {
			 * //System.out.println("collateralSenDate Sunction Date Check 1" +
			 * collateralSenDate); ActionError actionError = new
			 * ActionError("CollateraSancDtCheckError");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if (null
			 * != limitFundBasedSanctionedDated && limitFundBasedSanctionedDated.before(new
			 * Date(collateralSenDate))) {//&& industryNatureRetail.equals("RETAIL TRADE")
			 * //System.out.println(" Sanction Date FUnDBASE NONFUNDBASE 1 === " +
			 * limitFundBasedSanctionedDated); ActionError actionError = new
			 * ActionError("fundBaseRetailTradeSancDtCheckError");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if (null
			 * != limitNonFundBasedSanctionedDated &&
			 * limitNonFundBasedSanctionedDated.before(new Date(collateralSenDate))) {//&&
			 * industryNatureRetail.equals("RETAIL TRADE")
			 * //System.out.println(" Sanction Date FUBDBASE NONFUNDBASE 2 === " +
			 * limitNonFundBasedSanctionedDated); ActionError actionError = new
			 * ActionError("nonFundBaseRetailTradeSancDtCheckError");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if (null
			 * != sentDate && industryNatureRetail.equals("RETAIL TRADE") &&
			 * sentDate.before(new Date(collateralSenDate))) {
			 * System.out.println("collateralSenDate Sanction Date Check3333 " +
			 * collateralSenDate); ActionError actionError = new
			 * ActionError("RetailTradeSancDtCheckError");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } }
			 */
	...
	public static void validatePromDirDefaltDetails(HttpSession session, ActionErrors errors, String promDirDefaltFlg,
		 ...
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
		 * (credBurePromScor3 == 0) { ActionError actionError = new
		 * ActionError("credBurePromScor3Error");
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
		 * (credBurePromScor4 == 0) {
		 * //System.out.println("  credBurePromScor4...... "+credBurePromScor4);
		 * ActionError actionError = new ActionError("credBurePromScor4Error");
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
		 * (credBurePromScor5 == 0) { ActionError actionError = new
		 * ActionError("credBureKeyPromScor5Error");
		 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
		 */ if (credBureName1 == "" || credBureName1 == null) {
			 ...
			 * if (credBureName2 == "" || credBureName2 == null) { ActionError actionError =
			 * new ActionError("credBureName2Error");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
			 * (credBureName3 == "" || credBureName3 == null) {
			 * //System.out.println("  credBureName3..... "+credBureName3); ActionError
			 * actionError = new ActionError("credBureName3Error");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
			 * (credBureName4 == "" || credBureName4 == null) { ActionError actionError =
			 * new ActionError("credBureName4Error");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } if
			 * (credBureName5 == "" || credBureName5 == null) {
			 * //System.out.println("  credBureName3..... "+credBureName3); ActionError
			 * actionError = new ActionError("credBureName5Error");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
			 */
