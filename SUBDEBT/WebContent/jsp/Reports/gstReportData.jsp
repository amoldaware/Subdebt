...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	<TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font>&nbsp;From Date:</TD>
	<TD align="left" valign="top" class="tableData">
					...
					<TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font>&nbsp;To Date:</TD>
					<TD align="left" valign="top" class="tableData">
					<div align="left">
					...
					<TD align="right" valign="top" class="tableData">
						...
						<A href="javascript:submitForm('displaySummaryReport.do?method=getGstReport&val=download');"
