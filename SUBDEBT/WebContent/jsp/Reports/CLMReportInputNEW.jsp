		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
						...
						<TR>
							...
							<TR>
								...
								<TR>
								   ...
								   <html:radio name="reportForm" value="Y" property="checkValue" >Claim Approved Date </html:radio>&nbsp;&nbsp;
                                    <html:radio name="reportForm" value="N" property="checkValue" >Claim Payment Date</html:radio>
									</DIV>
									</TD>
									</TR>	
				...
				<TR>
					...
					<DIV align="center"><!-- <A
						href="javascript:submitForm('claimSettledReportNew.do?method=claimSettledReportNew')">
					...
					<IMG src="images/Cancel.gif" alt="Cancel" width="49" height="37"
						border="0"></a>
							<a href="javascript:submitForm('clmSettledExcelReportNew.do?method=clmSettledExcelReportNew&&fileType=CSVType&FlowLevel=ClmSettledExcelReport&&Flag=A')">
