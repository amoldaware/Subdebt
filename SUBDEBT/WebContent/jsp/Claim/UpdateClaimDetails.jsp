  				...
  				<tr>
                    <td colspan="4"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  					  ...
  					  <tr>
  						  ...
  						  %>
  						   <html:text property="<%=wcAsOnNPA%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true"onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" readonly="true"/></div>
  						  </td>
  						  <td class="TableData"><div align="center">
  						  <%
  						    wcOsAsOnInCivilSuit = "wcOsAsStatedInCivilSuit(key-"+j+")";
  						  %>
  						  <html:text property="<%=wcOsAsOnInCivilSuit%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true"   onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/></div>
  						  </td>
  						  <td class="TableData"><div align="center">
  						  <%
  						    wcOsAtLdgmntClm= "wcOsAsOnLodgementOfClaim(key-"+j+")";
  						  %>
  						  <html:text property="<%=wcOsAtLdgmntClm%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/>
  						  </div>
  						  </td>
						  <%
