...
** Payment Initiated Successfully For following cgpan's. 
  ...
  <body onload="disableBackButton()">
    ...
    <html:errors />
		...
		<html:form name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm"  action="allocatePaymentFinal.do?method=allocatePaymentFinal" method="POST" >
			...
			<a name="16:10" onclick="showText()" href="javascript:void(0);">Account details for remittance of payment</a>


			<div id="text4"  style="display:none;">Name of the Bank: State Bank of India</div>
			<div id="text5"  style="display:none;">Name of the Branch: Bandra Kurla Complex</div>
			<div id="text1"  style="display:none;">Account Name: Credit Guarantee Fund Trust for Micro and Small Enterprises</div>
			<div id="text2" style="display:none;">Account Number: 37817825400</div>
			<div id="text3" style="display:none;">IFSC Code: SBIN0004380</div>													
		...
		<TR>
			...
			<TD>
                ...
                <td valign="top" class="HeadingBg"> <div align="center">&nbsp;&nbsp;<strong>Sr.No</strong></div></td>
                  ...
                  <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>RP Number</strong></div></td>
			...
			<TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=rReport.getRPNumber()%></div></TD>				
