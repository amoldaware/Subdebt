...
function submitFinalMakePayment(action)
{
	...
	if(count==1)
	{
		var val = document.getElementById('checkboxval').value;
		if (val!= ""){
			makePaymentOK('allocatePaymentFinalSubmit.do?method=allocatePaymentFinalSubmit');
		}
		else{
...
String thiskey = "";
session.setAttribute("CurrentPage","allocatePaymentFinal.do?method=allocatePaymentFinal");
...
<% session.setAttribute("CurrentPage","allocatePaymentFinal.do?method=allocatePaymentFinal");%>
    ...
    <html:errors />
		<html:form name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm"  action="allocatePaymentFinal.do?method=allocatePaymentFinal" method="POST" >
		...
		<TR>
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <td valign="top"  class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>DAN Id</strong></div></td>
                  <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>CGPAN</strong></div></td>
                     ...
                     <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>DAN Date
                      </strong><br></div></td>
...
%>
             ...
             <TD width="10%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=Integer.parseInt(index+"")+1%></div></TD>
              <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=rReport.getBankName()%></div></TD>
		     <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=rReport.getPaymentIdF()%></div></TD>
            
             <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=rReport.getCgpan()%></div></TD>
             ...
             <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=rReport.getRPDATEF()%></div></TD>
                 ...
                 //  out.println("PaymentIdF=="+PaymentIdF);
                   String VitrualAcF =  rReport.getCgpan();
                   //out.println("VitrualAcF=="+VitrualAcF);
              ...
              //  String completeStr1=PaymentIdF+"@";
...
Total
		 					...
		 					<TR>
					<%-- <TD align="left" valign="top" class="ColumnBackground"><bean:message key="paymentInitiateDate" />:</TD>
					<TD align="left" valign="top" class="tableData">
						<div align="left">
							<html:text property="dtpaymentDate" size="20" maxlength="10" alt="Payment Date" name="rpAllocationForm" />
							<IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rpAllocationForm.dtpaymentDate')" align="center">
						</div>
					</TD> --%>
					<%-- <TD align="left" valign="top" class="ColumnBackground"><bean:message key="paymentAmount" /></TD>
					<TD align="left" valign="top" class="tableData">
						<input name="paymentAmountRP" class="form-control" id="paymentAmountRP"  type="text" size="30"  readonly/>
						<!-- <input name="paymentAmountRP" class="form-control" id="paymentAmountRP" onkeyup="isValidNumber(this)" onkeypress="return numbersOnly(this, event)" type="text" size="14" maxlength="12" value="" autocomplete="off"> -->
					</TD> --%>
					<TD align="left" valign="top" class="ColumnBackground"><bean:message key="paymentMode" />
					<!-- </TD> -->
					<!-- <TD align="left" valign="top" class="tableData"> -->
						<html:select property="paymentModeRP" name="rpAllocationForm" styleId="checkboxval">
              ...
              <tr align="center" valign="baseline">
           		 <td colspan="4"> 
           		 <div align="center"> 
		         <A href="javascript:submitFinalMakePayment('allocatePaymentFinalSubmit.do?method=allocatePaymentFinalSubmit')"><IMG src="images/Next.gif" alt="Next" width="49" height="37" border="0"></A>
...
<br/>
<div>
<input type="button" id="trap" value="OK" class="bouton" onclick="makePaymentOK('allocatePaymentFinalSubmit.do?method=allocatePaymentFinalSubmit');" style="left:0px;"/>
