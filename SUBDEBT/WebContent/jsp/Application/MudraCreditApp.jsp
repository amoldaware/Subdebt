...
<body onLoad="enableAssistance(),enableNone(),setConstEnabled(),enableDistrictOthers(),enableOtherLegalId(),enableSubsidyName(),calProjectCost(),calProjectOutlay(),enableGender(),enableHandiCrafts(),enabledcHandlooms(),init()">
...
<%@ include file="MudraCommonAppDetails.jsp" %>
<%@ include file="MudraCreditDetails.jsp" %>
...
We certify that the account is NOT NPA AND/OR  SMA2  as on 29/02/2020. We accept all Terms and Conditions of the Scheme. 
...
<%}	else if(appFlag.equals("3")){%>
	<A  id="submitbuttionlog" href="javascript:submitForm1('addTermCreditApp.do?method=submitApp')" ><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>		
