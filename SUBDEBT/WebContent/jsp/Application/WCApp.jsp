...
<html:errors/>
	...
	<TABLE width="95%" border="0" cellpadding="0" cellspacing="0">
		...
		<TR>
			...
			<TD>
				<DIV align="right"><A HREF="javascript:submitForm('workingCapitalHelp.do?method=workingCapitalHelp')"> HELP</A></DIV>
          ...
          <!--Check box Added pathinfotech on 15/05/2007-->
					...
					<TR >
						...
						if (request.getParameter("detail")!=null)
							...
							<%}
								...
								<A href="javascript:submitForm1('addTermCreditApp.do?method=submitApp')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>	
