...
<%
  session.setAttribute("CurrentPage", "ApplicationInBulkInput.do");
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:form action="ApplicationInBulkProcess.do?method=ApplicationInBulkProcess"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ApplicationInBulkProcess.do?method=ApplicationInBulkProcess')">
