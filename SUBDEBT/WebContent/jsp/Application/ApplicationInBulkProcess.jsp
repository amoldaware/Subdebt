...
<TABLE width="900" border="0" cellpadding="0" cellspacing="0">
	<html:form action="ApplicationInBulkInput.do?method=ApplicationInBulkInput"
			...
			<TABLE width="100%" border="1" align="left" cellpadding="0"
				...
				<TR>
					...
					<tr>	
				 	...
				 	<tr>
						...
						<td><font style="color:green; font-size: 15px;"><blink><b>Records Submitted for Processing,Batch ID - </b></blink></font></td>
					...
					<tr>	
						...
						<%if(all_eror_cnt>0){%>
						<td><a href="ApplicationInBulkProcess.do?method=ExportToFile&&fileType=XLSType&FlowLevel=Allerrors&csrfCode=<%=captchaSession%>"><font style="color:red; font-size: 15px;"><b><%=all_eror_cnt%></b></font></a></td>
						<%}else{ %>
						<td><b>0</b></td>
						<%}%>
							</TABLE>
				...
				<TR align="center" valign="baseline" >
					<TD colspan="2" width="700">
						<DIV align="center">
						 	<A href="javascript:submitForm('ApplicationInBulkInput.do?method=ApplicationInBulkInput')">
